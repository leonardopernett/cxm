  ...
  // fin
    ...
    public function actionExport2(){
        ...
        if ($fechaIniCat < '2020-01-01') {
          ...
          if ($idArbol == '17' || $idArbol == '8' || $idArbol == '105' || $idArbol == '485' || $idArbol == '2575' || $idArbol == '1371' || $idArbol == '2253' || $idArbol == '675' || $idArbol == '3263' || $idArbol == '3070' ||  $idArbol == '3071' ||  $idArbol == '3077' || $idArbol == '3069' || $idArbol == '3110' || $idArbol == '2919' || $idArbol == '3350' || $idArbol == '3110' || $idArbol == '3436' || $idArbol == '679') {
    ...
    public function actionShowformulario($formulario_id, $preview, $fill_values = false) {
        //DATOS QUE SERAN ENVIADOS AL FORMULARIO
                ...
                /* OBTIENE EL LISTADO DETALLADO DE TABLERO DE EXPERIENCIAS Y LLAMADA
                  EN MODO VISUALIZACI? FORMULARIO. */
    ...
    public function actionGuardaryenviarformulario() {
      ...
      $txtanulado = 0;
                ...
                if (!isset($modelRegistro)) {
                    ...
                    $modelRegistro->descripcion = 'Primera valoraci?';
                }
