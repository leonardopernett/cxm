    ...
    public function behaviors() {
                        ...
                        'rules' => [
                            [
                                'actions' => ['create', 'delete', 'eliminarencuesta',
                                    ...
                                    'metricalistmultipleform', 'cronalertadesempenolider', 'cronalertadesempenoasesor', 'showlistadesempenolider','correogrupal','prueba',
                                    'actualizarcorreos','comprobacion','pruebaactualizar','comprobacionlista','importarencuesta','listasformulario','enviarvalencias',
                                    'buscarllamadasbuzones','enviartextos','enviarmotivos','encuestasatifaccion','correoalerta','totalcomensaf'],
                                'allow' => true,
                                'roles' => ['@'],
        ...
        WHERE pe.cliente = ' . $nModel->cliente
            ...
            public function actionGuardaryenviarformulariogestion() {
                ...
                date_default_timezone_set('America/Bogota');
                if($data['hora_final'] != ""){
                        $hora_modificacion = Yii::$app->request->post('hora_modificacion');
                        $inicial = new DateTime($hora_modificacion);
                ...
                try {
                    ...
                    $modelBase->usado = "NO";
                    $modelBase->responsabilidad = (isset($responsabilidad)) ? Yii::$app->request->post('responsabilidad') : "";
                    $modelBase->canal = (isset($canal)) ? implode(", ", $canal) : "";
                    $modelBase->marca = (isset($marca)) ? implode(", ", $marca) : "";
        ...
        WHERE pe.cliente = ' . $model->cliente
            ...
            public function actionMetricalistmultipleform($search = null, $ids_selec = null, $id = null) {
                ...
                if (!is_null($search)) {
                    ...
                    $postIds_selec = Yii::$app->request->post('ids_selec');
                    if (isset($postIds_selec)) {
                        $ids_selec.=$postIds_selec . ',11,12';
                    } else {
                        $ids_selec = '11,12';
                    }
                    $data = \app\models\Textos::find()
