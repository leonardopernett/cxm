...
use app\models\UsuariosEvalua;
  ...
  class QrController extends \yii\web\Controller {
    ...
    public function actionIndex(){ 
      ...
      if($sessiones == "3205" || $sessiones == "2953" || $sessiones == "57" || $sessiones == "1475" || $sessiones == "69" || $sessiones == "1699" || $sessiones == "5658" || $sessiones == "3468" || $sessiones == "7952" || $sessiones == "4308"){ 
    ...
    public function actionViewqyr($idcaso){
      ...
      if ($model6->load($form)) {
        ...
        $message .= "<br>https://qa.grupokonecta.local/qa_managementv2/qa_managementv2/web/index.php";
        $message .= "</body></html>";
