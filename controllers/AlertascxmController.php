                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class='text-center' align='text-center' colspan='2' style='background-color: #C6C6C6;'>
                                    <label style='font-size: 12px;  margin: 30px;'>¡Hola equipo! Te comentamos que nos encantaria saber tú opinión, por eso te invitamos a ingresar a CXM y responder la encuesta en el siguiente link <a href='https://qa.grupokonecta.local/web/index.php/alertascxm/alertaencuesta?id_alerta=".$varIdAlertas."'>Ingresar a la encuesta</a></label>
                                </td>
                            </tr>
                        </tbody>
                    </table>
