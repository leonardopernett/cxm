...
use app\models\BasechatMotivos;
    ...
    class BaseChatController extends \yii\web\Controller {
                        ...
                        if (($gestor = fopen('categorias/' . $model->file->baseName . '.' . $model->file->extension, "r")) !== false) {                            
                            while (($datos = fgetcsv($gestor)) !== false) {
                                ...
                                for ($c=0; $c < $numero; $c++) { 
                                    ...
                                    // Yii::$app->db->createCommand()->insert('tbl_basechat_tigo',[
                                    //     'idencuesta' => ,
                                    //     'nombre_cliente' => ,
                                    //     'email' => ,
                                    //     'telefono_cliente' => ,
                                    ...
                                    //     'conocimiento' => ,
                                    //     'regresar_al_canal' => ,
                                    //     'interes_comprender_necesidad' => ,
                                    //     'ofrecer_alternativa' => ,
                                    //     'claridad' => ,
                                    //     'relevancia' => ,
                                    //     'comentario_contaco' => ,
                                    //     'desea_ser_contactado' => ,
                                    //     'nombre_cliente_encuesta' => ,
                                    //     'non_survey_data_flag' => ,
                                    //     'motivo_no_fcr' => ,
                                    //     'uno_mas_contactos' => ,
                                    //     'digital_canal' => ,
                                    //     'digital_subcanal' => ,
        ...
        if ($sheet->getCell("B".$row)->getValue() != null) {
		    ...
		    $varrtafecha = $aniorta.'-'.$mesrta.'-'.$diarta.' '.$horarta.':'.$minutosrta.':'.$segundosrta;
                   ...
                   // $varrtafecha = $aniorta.'-'.$mesrta.'-'.$diarta.' '.$horarta.':'.$minutosrta.':'.$segundosrta;
                    ...
                    if ($vartipo == "Mensajer铆a :: WhatsApp") {                        
                        $varpcrc = 3272;
                        $varcliente = 2919;
                        $varrn = 'BW';
                        $varinstitucion = '27';
                    ...
                    // $varbuscar = '@';
                    // $pos = strpos($varcompleteasesor, $varbuscar);                    
                    // $rest = substr($varcompleteasesor, 0, $pos);
                    ...
                    Yii::$app->db->createCommand()->insert('tbl_basechat_tigob',[                                        
                                        ...
                                        // 'conocimiento'=> $sheet->getCell("IE".$row)->getValue(),
                                        'conocimiento'=> $sheet->getCell("IP".$row)->getValue(),
                                        // 'digital_cliente_enc'=> $sheet->getCell("IG".$row)->getValue(),
                                        'digital_cliente_enc'=> $sheet->getCell("IR".$row)->getValue(),
                                        // 'uno_mas_contactos'=> $sheet->getCell("IM".$row)->getValue(),
                                        'uno_mas_contactos'=> $sheet->getCell("IX".$row)->getValue(),
                                        // 'tipo_canal_digital'=> $sheet->getCell("IN".$row)->getValue(),
                                        'tipo_canal_digital'=> $sheet->getCell("IY".$row)->getValue(),
                                        // 'unidad_identificador'=> $sheet->getCell("IO".$row)->getValue(),
                                        'unidad_identificador'=> $sheet->getCell("IZ".$row)->getValue(),
                                        // 'unidad_nombre'=> $sheet->getCell("IP".$row)->getValue(),
                                        'unidad_nombre'=> $sheet->getCell("JA".$row)->getValue(),
                                        // 'digital_form'=> $sheet->getCell("IW".$row)->getValue(),
                                        'digital_form'=> $sheet->getCell("JH".$row)->getValue(),
                                        // 'digital_b2b'=> $sheet->getCell("JD".$row)->getValue(),
                                        'digital_b2b'=> $sheet->getCell("JO".$row)->getValue(),
                                        // 'digital_canal'=> $sheet->getCell("JF".$row)->getValue(),
                                        'digital_canal'=> $sheet->getCell("JQ".$row)->getValue(),
                                        // 'tipo_producto_digital'=> $sheet->getCell("JH".$row)->getValue(),
                                        'tipo_producto_digital'=> $sheet->getCell("JS".$row)->getValue(),
                                        // 'msisdn'=> $sheet->getCell("JI".$row)->getValue(),
                                        'msisdn'=> $sheet->getCell("JT".$row)->getValue(),
                                        // 'tipo_ambiente'=> $sheet->getCell("JJ".$row)->getValue(),
                                        'tipo_ambiente'=> $sheet->getCell("JU".$row)->getValue(),
                                        // 'email_asesor'=> $sheet->getCell("JL".$row)->getValue(),
                                        'email_asesor'=> $sheet->getCell("JW".$row)->getValue(),
                                        // 'nombre_grupo'=> $sheet->getCell("JM".$row)->getValue(),
                                        'nombre_grupo'=> $sheet->getCell("JX".$row)->getValue(),
                                        // 'nombre_asesor'=> $sheet->getCell("JN".$row)->getValue(),
                                        'nombre_asesor'=> $sheet->getCell("JY".$row)->getValue(),
                                        // 'ticked_id'=> $sheet->getCell("JO".$row)->getValue(),
                                        'ticked_id'=> $sheet->getCell("JZ".$row)->getValue(),
                                        // 'ticket_via'=> $sheet->getCell("JQ".$row)->getValue(),
                                        'ticket_via'=> $sheet->getCell("KB".$row)->getValue(),
                                        // 'digital_subcanal'=> $sheet->getCell("JW".$row)->getValue(),
                                        'digital_subcanal'=> $sheet->getCell("KH".$row)->getValue(),
                                        // 'digital_comentarioadic'=> $sheet->getCell("OU".$row)->getValue(),
                                        'digital_comentarioadic'=> $sheet->getCell("PF".$row)->getValue(),
                                        // 'tagged_original'=> $sheet->getCell("PX".$row)->getValue(),
                                        ...
                                        // 'b2b' => $sheet->getCell("J".$row)->getValue(),
                                        // 'response_date' => $fechaencuesta,
                                        // 'tipo_canal_digital' => $sheet->getCell("BC".$row)->getValue(),
                                        // 'tipo_producto_digital' => $sheet->getCell("BE".$row)->getValue(),
                                        // 'msisdn' => $sheet->getCell("BF".$row)->getValue(),
                                        // 'tipo_ambiente' => $sheet->getCell("BG".$row)->getValue(),
                                        // 'email_asesor' => $sheet->getCell("BI".$row)->getValue(),
                                        // 'nombre_grupo' => $sheet->getCell("BJ".$row)->getValue(),
                                        // 'nobre_asesor' => $sheet->getCell("BK".$row)->getValue(),
                                        ...
                                        // 'regresar_al_canal' => $sheet->getCell("BV".$row)->getValue(),
                                        // 'interes_comprender_necesidad' => $sheet->getCell("BW".$row)->getValue(),
                                        // 'ofrecer_alternativa' => $sheet->getCell("BX".$row)->getValue(),
                                        // 'claridad' => $sheet->getCell("BY".$row)->getValue(),
                                        // 'relevancia' => $sheet->getCell("BZ".$row)->getValue(),
                                        // 'comentario_contaco' => $sheet->getCell("CA".$row)->getValue(),
                                        // 'desea_ser_contactado' => $sheet->getCell("CB".$row)->getValue(),
                                        // 'nombre_cliente_encuesta' => $sheet->getCell("CC".$row)->getValue(),
                                        // 'non_survey_data_flag' => $sheet->getCell("CE".$row)->getValue(),
                                        // 'motivo_no_fcr' => $sheet->getCell("CM".$row)->getValue(),
                                        // 'uno_mas_contactos' => $sheet->getCell("CN".$row)->getValue(),
                                        // 'digital_canal' => $sheet->getCell("CP".$row)->getValue(),
                                        // 'digital_subcanal' => $sheet->getCell("CQ".$row)->getValue(),
                                        // 'comentario_mejoras' => $sheet->getCell("CR".$row)->getValue(),
                                        // 'lourney' => $sheet->getCell("CT".$row)->getValue(),
                                        // 'etiquetas' => $sheet->getCell("CW".$row)->getValue(),
                                        // 'tipo_encuesta_digital' => $sheet->getCell("DY".$row)->getValue(),
        ...
        public function actionShowformulariogestion($basesatisfaccion_id, $preview, $aleatorio = null, $fill_values, $view = "index",$banderaescalado = false, $idtmp = null) {
                ...
                // $modelBase = BasechatTigo::findOne($basesatisfaccion_id);
                ...
                if ((is_null($evaluado) || empty($evaluado) || $evaluado == '') && ($preview != 1 && $fill_values != 1)) {
                    $msg = \Yii::t('app', 'No se encuentra el evaluado asociado: ' . $modelBase->evaluadoid . '. Para realizar la gesti贸n haga la creaci贸n de los datos del evaluado y as铆gnele un equipo y lider');
                ...
                if (count($modelReglaNegocio) == 0) {
                    $msg = \Yii::t('app', 'Este registro no tiene una parametrizaci贸n asociada:' . $modelBase->id);
                    Yii::$app->session->setFlash('danger', $msg);
                    return $this->redirect([$redct]);
                }
                ...
                if ((is_null($equipoevaluado) || empty($equipoevaluado) || $equipoevaluado == '') && ($preview != 1 && $fill_values != 1)) {
                    $msg = \Yii::t('app', 'El evaluado ' . $modelBase->evaluadoid . ' no est谩 incluido en alg煤n equipo');
                    Yii::$app->session->setFlash('danger', $msg);
                    return $this->redirect([$redct]);
                }
                ...
                if ((!is_null($equipoevaluado) || !empty($equipoevaluado) || $equipoevaluado != '')) {
                    ...
                    // $modelBase->lider_equipo = ($modelBase->lider_equipo == '' || is_null($modelBase->lider_equipo)) ? $equipo->usua_id : $modelBase->lider_equipo;
                ...
                /* OBTIENE EL LISTADO DETALLADO DE TABLERO DE EXPERIENCIAS Y LLAMADA
                  EN MODO VISUALIZACI脫N FORMULARIO. */
                ...
                if (count($data->preguntas) == 0) {
                    $msg = \Yii::t('app', 'No existe parametrizaci贸n asociada para este formulario:' . $modelBase->basesatisfaccion_id);
                    Yii::$app->session->setFlash('danger', $msg);
                    return $this->redirect([$redct]);
                }
                ...
                if (empty($form_val)) {
                    $msg = \Yii::t('app', 'No existe formulario asociada para esta gesti贸n:' . $modelBase->basesatisfaccion_id);
                    Yii::$app->session->setFlash('danger', $msg);
                    //var_dump($data); die;
                ...
                /* if (!isset($data->responsabilidad['EQUIVOCACION'])||!isset($data->responsabilidad['CANAL'])||!isset($data->responsabilidad['MARCA'])) {
                  $msg = \Yii::t('app', 'Por favor verifique la configuraci贸n de la PROTECCI脫N DE LA EXPERIENCIA, ya que falta parametrizar alguna de sus opciones');
                  Yii::$app->session->setFlash('danger', $msg);
                  } */
                //echo "<pre>";
            ...
            public function actionConsultarcalificacionsubi() {
                ...
                try {
                     ...
                     * 
                      ...
                      $params = [];
                      $params['titulo'] = 'Te han realizado una valoraci贸n';
                      $params['pcrc'] = '';
                      $params['descripcion'] = '';
              ...
              $webservicesresponse = null;
                      ...
                      Yii::$app->session->setFlash('danger', Yii::t('app', 'No se pudo realizar conexi贸n con la plataforma Amigo'));
                      } */
                } catch (\Exception $exc) {
...
//        
	...
	$phpExc = new \PHPExcel();
        $phpExc->getProperties()
                ...
                ->setTitle("Listado de Gesti髇")
                ->setSubject("Fuentes de Informaci髇")
                ->setDescription("Este archivo contiene el listado de gesti髇")
                ->setKeywords("Lista de gesti髇");
	...
	$phpExc->getActiveSheet()->SetCellValue('A2','Numero Ticket');
        ...
        $phpExc->getActiveSheet()->SetCellValue('B2','Fecha Creaci贸n');
        ...
        $phpExc->getActiveSheet()->SetCellValue('D2','Fecha Transacci贸n');
        ...
        $phpExc->getActiveSheet()->SetCellValue('J2','驴Que tan probable es que recomiendas Tigo a tus familiares y amigos?');
        ...
        $phpExc->getActiveSheet()->SetCellValue('K2','驴Que tan satisfecho estas con la atenci贸n recibida?');
        ...
        $phpExc->getActiveSheet()->SetCellValue('L2','驴Que tan f谩cil fue resolver tu consulta/solicitud?');
        ...
        $phpExc->getActiveSheet()->SetCellValue('M2','驴Resolvimos el motivo de tu solicitud?');
        ...
        $phpExc->getActiveSheet()->SetCellValue('N2','驴Que tan satisfecho estas con el conocimiento que demostr贸 el asesor para resolver tu consulta?');
        ...
        $phpExc->getActiveSheet()->SetCellValue('O2','Fecha de calificaci贸n');
        ...
        $phpExc->getActiveSheet()->SetCellValue('S2','Soluci贸n');
        ...
        $phpExc->getActiveSheet()->SetCellValue('T2','Observaci贸n');
	...
	$hoy = getdate();
      ...
      public function actionExportcol(){
        ...
        $phpExc->getActiveSheet()->SetCellValue('H2','驴Que tan probable es que recomiendas Tigo a tus familiares y amigos?');
        $phpExc->getActiveSheet()->getStyle('H2')->getFont()->setBold(true);
        $phpExc->getActiveSheet()->getStyle('H2')->applyFromArray($styleArray);            
        $phpExc->getActiveSheet()->getStyle('H2')->applyFromArray($styleColor);
        $phpExc->getActiveSheet()->getStyle('H2')->applyFromArray($styleArraySubTitle2);
        
        $phpExc->getActiveSheet()->SetCellValue('I2','驴Que tan satisfecho estas con la atenci贸n recibida?');
        $phpExc->getActiveSheet()->getStyle('I2')->getFont()->setBold(true);
        $phpExc->getActiveSheet()->getStyle('I2')->applyFromArray($styleArray);            
        $phpExc->getActiveSheet()->getStyle('I2')->applyFromArray($styleColor);
        $phpExc->getActiveSheet()->getStyle('I2')->applyFromArray($styleArraySubTitle2);
        
        $phpExc->getActiveSheet()->SetCellValue('J2','驴Que tan f谩cil fue resolver tu consulta/solicitud?');
        $phpExc->getActiveSheet()->getStyle('J2')->getFont()->setBold(true);
        $phpExc->getActiveSheet()->getStyle('J2')->applyFromArray($styleArray);            
        $phpExc->getActiveSheet()->getStyle('J2')->applyFromArray($styleColor);
        $phpExc->getActiveSheet()->getStyle('J2')->applyFromArray($styleArraySubTitle2);
        
        $phpExc->getActiveSheet()->SetCellValue('K2','驴Resolvimos el motivo de tu solicitud?');
        $phpExc->getActiveSheet()->getStyle('K2')->getFont()->setBold(true);
        $phpExc->getActiveSheet()->getStyle('K2')->applyFromArray($styleArray);            
        $phpExc->getActiveSheet()->getStyle('K2')->applyFromArray($styleColor);
        $phpExc->getActiveSheet()->getStyle('K2')->applyFromArray($styleArraySubTitle2);
        
        $phpExc->getActiveSheet()->SetCellValue('L2','驴Que tan satisfecho estas con el conocimiento que demostr贸 el asesor para resolver tu consulta?');
        $phpExc->getActiveSheet()->getStyle('L2')->getFont()->setBold(true);
        $phpExc->getActiveSheet()->getStyle('L2')->applyFromArray($styleArray);            
        $phpExc->getActiveSheet()->getStyle('L2')->applyFromArray($styleColor);
        $phpExc->getActiveSheet()->getStyle('L2')->applyFromArray($styleArraySubTitle2);
        
        $phpExc->getActiveSheet()->SetCellValue('M2','Fecha de calificaci贸n');
        $phpExc->getActiveSheet()->getStyle('M2')->getFont()->setBold(true);
        $phpExc->getActiveSheet()->getStyle('M2')->applyFromArray($styleArray);            
        $phpExc->getActiveSheet()->getStyle('M2')->applyFromArray($styleColor);
        $phpExc->getActiveSheet()->getStyle('M2')->applyFromArray($styleArraySubTitle2);
        ...
        $phpExc->getActiveSheet()->SetCellValue('Q2','Soluci贸n');
        $phpExc->getActiveSheet()->getStyle('Q2')->getFont()->setBold(true);
        $phpExc->getActiveSheet()->getStyle('Q2')->applyFromArray($styleArray);            
        $phpExc->getActiveSheet()->getStyle('Q2')->applyFromArray($styleColor);
        $phpExc->getActiveSheet()->getStyle('Q2')->applyFromArray($styleArraySubTitle2);
        
        $phpExc->getActiveSheet()->SetCellValue('R2','Observaci贸n');
        $phpExc->getActiveSheet()->getStyle('R2')->getFont()->setBold(true);
        $phpExc->getActiveSheet()->getStyle('R2')->applyFromArray($styleArray);            
        $phpExc->getActiveSheet()->getStyle('R2')->applyFromArray($styleColor);
        $phpExc->getActiveSheet()->getStyle('R2')->applyFromArray($styleArraySubTitle2);
