  ...
  class DistribuciondosController extends \yii\web\Controller {
    ...
    public function actionProcesaequipos(){
      ...
      if($model->load($form)){
        ...
        if ($varGrupoCorte == "3") {
          $varIdClientes = [112, 115, 120, 129, 134, 136, 149, 171, 172, 185, 214, 221, 224, 228, 230, 246, 232, 258, 266, 274, 276, 282, 283, 287, 291, 292, 293, 294, 298, 299, 300, 301, 302, 303, 305, 306, 307, 308, 309, 311, 312, 315, 316, 317, 319, 320, 321, 322, 323, 324, 325, 331, 332, 334, 335, 336, 337, 342, 343, 401, 404, 406, 411, 390, 459, 397, 460, 453, 707, 348, 379, 380];          
        }
