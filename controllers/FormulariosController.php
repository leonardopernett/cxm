                ...
                'denyCallback' => function ($rule, $action) {
                    ...
                    return $action->controller->redirect($url);
                        ...
                        'rules' => [
                            ...
                            return Yii::$app->user->identity->isAdminProcesos() || Yii::$app->user->identity->isVerexterno();
                        },
                            ],
                            [
                            ...
                            [
                                ...
                                'roles' => ['@'],
                                'matchCallback' => function() {
                            return Yii::$app->user->identity->isAdminProcesos() || Yii::$app->user->identity->isCuadroMando() || Yii::$app->user->identity->isReportes() || Yii::$app->user->identity->isVerexterno();
                        },
                            ],
                        ],
                    ],
