    ...
    public function behaviors() {
        return [
            ...
            public function actionGuardaryenviarformulario() {
                ...
                $params = [];
                $params['titulo'] = 'Tienes una nueva evaluación';
                $params['pcrc'] = '';
                $params['descripcion'] = '';
                ...
                $params['url'] = '' . Url::toRoute('formularios/showformulariodiligenciadoamigo', true) . '?form_id=' . base64_encode($ejecucion[0]->id);
            ...
            public function actionGetarboles($search = null, $id = null) {
                ...
                if (!is_null($search)) {
                    $data = \app\models\TmpreportesArbol::find()
                            ->join("JOIN", "rel_usuarios_roles", "rel_usuarios_roles.rel_usua_id = tbl_tmpreportes_arbol.usua_id")
                            ->join("JOIN", "tbl_permisos_roles_arbols", "tbl_tmpreportes_arbol.arbol_id = tbl_permisos_roles_arbols.arbol_id")
                            ...
                            ->where([
                                ...
                                "tbl_permisos_roles_arbols.snver_grafica" => 1])
                            ->andWhere("rel_usuarios_roles.rel_role_id = tbl_permisos_roles_arbols.role_id")
