                        ...
                        'rules' => [
                            [
                                'actions' => ['create', 'delete', 'eliminarencuesta',
                                    ...
                                    'guardaryenviarformulariogestion', 'eliminartmpform', 'buscarllamadasmasivas'],
                                'allow' => true,
                                'roles' => ['@'],
                            ...
                            [
                                'actions' => ['baseinicial', 'clientebasesatisfaccion',
            ...
            public function actionDelete($id) {
                ...
                try {/*
                  ...
                  \app\models\RespuestaBaseSatisfaccion::deleteAll(["id_basesatisfaccion" => $model->id]); */
                    ...
                    $msg = \Yii::t('app', 'Gestion Eliminada con éxito: ' . $model->id);
                    $model->delete();
                } catch (Exception $exc) {
        ...
        WHERE pe.cliente = ' . $nModel->cliente
            ...
            public function actionReabrirformulariogestionsatisfaccion($id) {
                ...
                return $this->redirect(['basesatisfaccion/showformulariogestion',
                            'basesatisfaccion_id' => $model->id, 'preview' => 0, 'fill_values' => false]);
            }
             ...
             * @return boolean
             */
            public function actionBuscarllamadas($id, $connid) {
             ...
             * @version Release: $Id$
             */
            public function actionShowformulariogestion($basesatisfaccion_id, $preview, $fill_values) {
                ...
                if (empty($form_val)) {
                    ...
                    Yii::$app->session->setFlash('danger', $msg);
                    return $this->render("showformulariosatisfaccion", ["data" => $data, "formulario" => false]);
                }
             ...
             * @version Release: $Id$
             */
            public function actionShowformulariogestionamigo($basesatisfaccion_id, $preview, $fill_values) {
