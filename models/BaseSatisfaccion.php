 ...
 * @property string $modalidad_encuesta
...
class BaseSatisfaccion extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            , 'canal', 'marca', 'equivocacion', 'escalado', 'aliados' ], 'string'],
            [['fecha_gestion'], 'safe'],
            [['rn'], 'string', 'max' => 2],
            [['modalidad_encuesta'], 'string', 'max' => 1],
    ...
    public function attributeLabels() {
        return [
            ...
            'escalado' => Yii::t('app', 'escalado'),
            'modalidad_encuesta' => Yii::t('app', 'Modalidad Encuesta'),
        ];
    }
