...
class ReportesAdministracion extends Model
{
  ...
  public function filter_user_permits ($type,$data, $sessiones, $id){
    ...
    if($id_user == 3205 || $id_user == 2953 || $id_user == 3468 || $id_user == 69 || $id_user == 8 || $id_user == 57 || $id_user == 3229 || $id_user == 1515 || $id_user == 2991 || $id_user == 6636 || $id_user == 4457 || $id_user == 2511 || $id_user == 6639 || $id_user == 637 || $id_user == 1083 || $sessiones == 5658 || $sessiones == 1475 || $sessiones == 1699 || $sessiones == 7952 || $sessiones == 1317 || $sessiones == 9297 || $sessiones == 8031 || $sessiones == 1483){ 
      return $data;
    }
    else{
