 ...
 */
class UsuariosEvalua extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['fechacrecion'], 'safe'],
            [['posicion', 'funcion', 'usuario_red', 'email_corporativo', 'documento_jefe'], 'string', 'max' => 150],
            [['nombre_jefe', 'cargo_jefe', 'directorarea', 'clientearea'], 'string', 'max' => 150]
        ];
    }
