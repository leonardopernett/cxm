...
$url = \yii\helpers\Url::to(['equiposlist', 'evaluado_id'=>$model->evaluado_id]);
?>
...
<div class="equipos-evaluados-form">
    ...
    <?= $form->field($model, 'equipo_id')->widget(Select2::classname(), [        
        'language' => 'es',
    ...
    <div style="height: 5px">
        <?= $form->field($model, 'evaluado_id')->hiddenInput()->label('') ?>
    </div>    
