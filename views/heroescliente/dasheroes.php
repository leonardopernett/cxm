            ...
            <div class="card1 mb">
                <table id="myTable" class="table table-hover table-bordered" style="margin-top:20px" ><!--Titulo de la tabla no se muestra-->
                    ...
                    <thead><!--Emcabezados de la tabla -->
                        ...
                        <th scope="col" class="text-center" style="background-color: #F5F3F3;"><label style="font-size: 15px; width:10; "><?= Yii::t('app', 'Valorar') ?></label></th>
                        <th scope="col" class="text-center" style="background-color: #F5F3F3;"><label style="font-size: 15px; width:140px;" ><?= Yii::t('app', 'Estado') ?></label></th>
                    ...
                    <?php foreach ($varData as $value) : ?>
                        ...
                        <?= Html::a('<em class="fas fa-edit" style="font-size: 25px; color: #559FFF;"></em>',  ['heroescliente/interaccionmanual','embajadorpostular'=> $value['embajadorpostular']], ['target' => '_blank',]) ?></td>
