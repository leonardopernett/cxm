...
$this->title = 'Procesos Administrador - Parametrizar Formularios No Guarden Pcrc';
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card1 mb" style="background: #6b97b1; ">
        <label style="font-size: 20px; color: #FFFFFF;"><?php echo "Acciones Formulario No Guarde Pcrc"; ?> </label>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="card1 mb">
        ...
        <?= $form->field($model, 'argumentos', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['maxlength' => 50, 'id' => 'idTexto', 'placeholder'=>'Ingresar Comentarios'])->label('') ?>
        ...
        <br>
         ...
         <?= Html::submitButton(Yii::t('app', 'Bloquear'),
                            ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary',
                                'data-toggle' => 'tooltip',
                                'onclick' => 'verificar();',
                                'title' => 'Bloquear Formulario con el Pcrc']) 
        ?>
    ...
    <div class="col-md-8">
      ...
      <div class="card1 mb">
        <table id="myTable" class="table table-hover table-bordered" style="margin-top:20px" >
          <caption><label><em class="fas fa-list" style="font-size: 20px; color: #b52aef;"></em> <?= Yii::t('app', 'Histórico de Formularios restingidos') ?></label></caption>
          <thead>
...
<script type="text/javascript">
  function verificar(){
    ...
    if (varidEquipo == "") {
      ...
      swal.fire("!!! Advertencia !!!","Se debe de ingresar un comentario al proceso","warning");
      return;
    }
  };
