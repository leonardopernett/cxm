...
<div class="capaInfo" id="idCapaInfo" style="display: inline;">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card1 mb" style="background: #6b97b1; ">
        <label style="font-size: 20px; color: #FFFFFF;"><?php echo "Estados para Quejas y Reclamos"; ?> </label>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="card1 mb">
                <?= $form->field($model, 'nombre', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['maxlength' => 50, 'id' => 'idTexto', 'placeholder'=>'Ingresar Estados QyR'])->label('') ?>
    ...
    <div class="col-md-8">
      ...
      <div class="card1 mb">
        <table id="myTable" class="table table-hover table-bordered" style="margin-top:20px" >
          <caption><label><em class="fas fa-list" style="font-size: 20px; color: #b52aef;"></em> <?= Yii::t('app', 'Listado de Estados QyR') ?></label></caption>
          <thead>
            <th scope="col" class="text-center" style="background-color: #F5F3F3;"><label style="font-size: 15px;"><?= Yii::t('app', 'Id Estado') ?></label></th>
            <th scope="col" class="text-center" style="background-color: #F5F3F3;"><label style="font-size: 15px;"><?= Yii::t('app', 'Nombre Estado') ?></label></th>
          ...
          <tbody>
            <?php
              foreach ($varListAlertas as $key => $value) {
                $varId = $value['id_estado'];
            ...
            ?>
              <tr>
                ...
                <td class="text-center">
                  <?= Html::a('<em class="fas fa-times" style="font-size: 15px; color: #FC4343;"></em>',  ['deleteestadoqyr','id'=> $value['id_estado']], ['class' => 'btn btn-primary', 'data-toggle' => 'tooltip', 'style' => " background-color: #337ab700;", 'title' => 'Eliminar']) ?>
                </td>
              </tr>
            <?php
              }
