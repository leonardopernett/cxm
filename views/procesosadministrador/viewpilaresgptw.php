...
$this->title = 'Procesos Administrador - pilares GPTW';
...
<div class="capaInfo" id="idCapaInfo" style="display: inline;">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card1 mb" style="background: #6b97b1; ">
        <label style="font-size: 20px; color: #FFFFFF;"><?php echo "Pilares para el Great Place To Work"; ?> </label>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="card1 mb">
                <?= $form->field($model, 'nombre_pilar', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['maxlength' => 250, 'id' => 'idTexto', 'placeholder'=>'Ingresar Pilar GPTW'])->label('') ?>
    ...
    <div class="col-md-8">
      ...
      <div class="card1 mb">
        <table id="myTable" class="table table-hover table-bordered" style="margin-top:20px" >
          ...
          <thead>
            <th scope="col" class="text-center" style="background-color: #F5F3F3;"><label style="font-size: 15px;"><?= Yii::t('app', 'Id Pilar') ?></label></th>
            <th scope="col" class="text-center" style="background-color: #F5F3F3;"><label style="font-size: 15px;"><?= Yii::t('app', 'Nombre Pilar') ?></label></th>
          ...
          <tbody>
            <?php
              foreach ($varListEquipos as $key => $value) {
                $varId = $value['id_pilares'];
                $varNombre = $value['nombre_pilar'];
            ...
            ?>
              <tr>
                ...
                <td class="text-center">
                  <?= Html::a('<em class="fas fa-times" style="font-size: 15px; color: #FC4343;"></em>',  ['deletepilares','id'=> $value['id_pilares']], ['class' => 'btn btn-primary', 'data-toggle' => 'tooltip', 'style' => " background-color: #337ab700;", 'title' => 'Eliminar']) ?>
                </td>
              </tr>
            <?php
              }
