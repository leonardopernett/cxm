...
<div id="capaPReportesId" class="capaReportes" style="display: inline;">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="card1 mb">
                <label style="font-size: 15px;"><em class="fas fa-list-alt" style="font-size: 15px; color: #ffc034;"></em><?= Yii::t('app', ' Lista de Datos - Reportes Enviados') ?></label>

                <table id="myTableEnviados" class="table table-hover table-bordered" style="margin-top:20px" >
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-center" style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?= Yii::t('app', 'Correo') ?></label></th>
                    ...
                    <tbody>
                        <?php
                        foreach ($varDataListReport as $key => $value) {
                            
                        ?>
                        <tr>
                            <td><label style="font-size: 12px;"><?php echo  $value['documentopersonalsatu']; ?></label></td>
                            <td><label style="font-size: 12px;"><?php echo  $value['correosatu']; ?></label></td>
