<?php
    ...
    <div class="capaUno" id="idCapaUno" style="display: inline;">
        <div class="row">
            <div class="col-md-12">
                ...
                <label style="font-size: 20px; color: #FFFFFF;"><?php echo "Agregar PCRC para exportar valoraciones de Comdata"; ?> </label>
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="row">
            ...
            <!-- Tabla donde están los PCRC agregados-->
            <div class="col-md-8">
    ...
    <script type="text/javascript">
        ...
        function eliminar_pcrc(id_pcrc){
            ...
            $.ajax({
                method: "GET",
                url: "deletepcrcvaloracionescomdata",
                data: {
                    id_pcrc:id_pcrc                    
                },
        ...
        function cargar_lista_pcrc()  {
            ...
            $.ajax({
                method: "GET",
                url: "cargarlistapcrcvaloracionescomdata",
                success: function(response) {
