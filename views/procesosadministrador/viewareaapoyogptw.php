...
$this->title = 'Procesos Administrador - áreas de apoyo GPTW';
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card1 mb" style="background: #6b97b1; ">
        <label style="font-size: 20px; color: #FFFFFF;"><?php echo "Área de apoyo para el Great Place To Work"; ?> </label>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-8">
      ...
      <div class="card1 mb">
        <table id="myTable" class="table table-hover table-bordered" style="margin-top:20px" >
          <caption><label><em class="fas fa-list" style="font-size: 20px; color: #b52aef;"></em> <?= Yii::t('app', 'Listado de Áreas de apoyo GPTW') ?></label></caption>
          <thead>
            <th scope="col" class="text-center" style="background-color: #F5F3F3;"><label style="font-size: 15px;"><?= Yii::t('app', 'Id Area apoyo') ?></label></th>
            <th scope="col" class="text-center" style="background-color: #F5F3F3;"><label style="font-size: 15px;"><?= Yii::t('app', 'Nombre Área apoyo') ?></label></th>
          ...
          <tbody>
            <?php
              foreach ($varListAreaapoyo as $key => $value) {
                $varId = $value['id_areaapoyo'];
            ...
            ?>
              <tr>
                ...
                <td class="text-center">
                  <?= Html::a('<em class="fas fa-times" style="font-size: 15px; color: #FC4343;"></em>',  ['deleteareaapoyo','id'=> $value['id_areaapoyo']], ['class' => 'btn btn-primary', 'data-toggle' => 'tooltip', 'style' => " background-color: #337ab700;", 'title' => 'Eliminar']) ?>
                </td>
              </tr>
            <?php
              }
