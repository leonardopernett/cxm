...
$this->title = 'Procesos Administrador - Áreas para Q&R';
...
<div class="capaInfo" id="idCapaInfo" style="display: inline;">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card1 mb" style="background: #6b97b1; ">
        <label style="font-size: 20px; color: #FFFFFF;"><?php echo "Áreas para Quejas y Reclamos"; ?> </label>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="card1 mb">
                <?= $form->field($model, 'nombre', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['maxlength' => 50, 'id' => 'idTexto', 'placeholder'=>'Ingresar Área'])->label('') ?>
    ...
    <div class="col-md-8">
      ...
      <div class="card1 mb">
        <table id="myTable" class="table table-hover table-bordered" style="margin-top:20px" >
          <caption><label><em class="fas fa-list" style="font-size: 20px; color: #b52aef;"></em> <?= Yii::t('app', 'Listado de Áreas para QyR') ?></label></caption>
          <thead>
            <th scope="col" class="text-center" style="background-color: #F5F3F3;"><label style="font-size: 15px;"><?= Yii::t('app', 'Id Área') ?></label></th>
            <th scope="col" class="text-center" style="background-color: #F5F3F3;"><label style="font-size: 15px;"><?= Yii::t('app', 'Nombre Área') ?></label></th>
          ...
          <tbody>
            <?php
              foreach ($varListAreasqyr as $key => $value) {
                $varId = $value['id'];
            ...
            ?>
              <tr>
                ...
                <td class="text-center">
                  <?= Html::a('<em class="fas fa-times" style="font-size: 15px; color: #FC4343;"></em>',  ['deleteareasqyr','id'=> $value['id']], ['class' => 'btn btn-primary', 'data-toggle' => 'tooltip', 'style' => " background-color: #337ab700;", 'title' => 'Eliminar']) ?>
                </td>
              </tr>
            <?php
              }
...
<script type="text/javascript">
  function verificar(){
    ...
    if (varidEquipo == "") {
      ...
      swal.fire("!!! Advertencia !!!","Se debe llenar un Área","warning");
      return;
    }
  };
