...
$this->title = 'Dashboard Voz del Cliente';
    ...
    if ($fechaIniCat < '2020-01-01') {
      ...
      if ($idArbol == '17' || $idArbol == '8' || $idArbol == '105' || $idArbol == '2575' || $idArbol == '3263' || $idArbol == '1371' || $idArbol == '2253' || $idArbol == '675' || $idArbol == '3070' ||  $idArbol == '3071' ||  $idArbol == '3077' || $idArbol == '3069' || $idArbol == '3110' || $idArbol == '2919' || $idArbol == '3350' || $idArbol == '3110' || $idArbol == '3410') {
                    ...
                    <div class="col-md-6">
                      <div class="card2 mb">
                        <table id="myTable0"  class="table table-striped table-bordered detail-view formDinamico">
                          <thead>
                            <tr>
                              <th class="text-center" style="font-size: 15px; cursor: pointer" onclick="sortTable1(4, 'str')"><?= Yii::t('app', 'C贸digo Pcrc ') ?><span class="glyphicon glyphicon-chevron-down"></span></th>
                        ...
                        <tbody>
                          <?php                            
                            ...
                            foreach ($txtvDatosMotivos as $key => $value) {
                              ...
                              if ($txtvCantMotivos != 0 && $txtTotalLlamadas != 0) {
                                $txtParticipaci贸n2 = round(($txtvCantMotivos / $txtTotalLlamadas) * 100,2);
                              }else{
                                $txtParticipaci贸n2 = 0;
                              } 
                          ...
                          ?>
                            <tr>
                              ...
                              <td class="text-center"><?php echo $txtParticipaci贸n2." %"; ?></td>
...
function sortTable(n,type) {
  ...
  $(function() {
        ...
        Highcharts.setOptions({
            ...
            series: [{
              name: 'Porcentaje de participaci贸n',
