	...
	<div class="row">
		<div class="col-md-12">
			<div class="card1 mb">
				<div class="row">
					<div class="col-md-6">
						<label style="font-size: 15px;"><i class="fas fa-paperclip" style="font-size: 15px; color: #FFC72C;"></i> Categorias: </label> 
					...
					<div class="col-md-6">
						<label style="font-size: 15px;"><i class="fas fa-list" style="font-size: 15px; color: #FFC72C;"></i> Seleccion: </label> 
...
<div class="capaOne" style="display: inline;">
    <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card1 mb">
                            <label style="font-size: 15px;"><i class="fas fa-save" style="font-size: 15px; color: #FFC72C;"></i> Guardar Proceso: </label> 
