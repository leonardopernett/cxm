...
$this->title = 'Dashboard - Parametrizar Sociedades a Codigos Pcrc -';
...
<div id="capaSeleccionId" class="capaSeleccion" style="display: inline;">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card1 mb">
                <label style="font-size: 15px;"><em class="fas fa-info-circle" style="font-size: 20px; color: #ff453c;"></em> <?= Yii::t('app', 'Importante: Este modulo es para  asignar la sociedad a todos los codigos pcrc parametrizados en el escuchar +.') ?></label>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="card1 mb">
                <label style="font-size: 15px;"><em class="fas fa-check" style="font-size: 15px; color: #FFC72C;"></em> <?= Yii::t('app', 'Seleccionar Sociedad') ?> </label> 
                ...
                <label style="font-size: 15px;"><em class="fas fa-edit" style="font-size: 15px; color: #FFC72C;"></em> <?= Yii::t('app', 'Código Pcrc') ?> </label> 
                <?= $form->field($model, 'cod_pcrc', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['id' => 'idpcrc', 'value'=>$txtServicioCategorias, 'readonly'=>'readonly']) ?>
...
<script type="text/javascript">
    function varVerifica(){
        var varidvararbol = document.getElementById("idSociedades").value;
