...
<div class="capapp" style="display: inline;">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card1 mb">
                <label><em class="fas fa-bookmark" style="font-size: 20px; color: #559FFF;"></em> </label>
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label><?= Yii::t('app', '* Dimension') ?></label>
                        <?=
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card1 mb">                                                                      
                                    <?=
                                        Html::submitButton(Yii::t('app', 'Realizar Valoracion'), ['onclick' => 'verificarvar();', 'class' => 'btn btn-success'])
                                    ?>   
                                </div>
                            </div>
                            <div class="col-md-6">
