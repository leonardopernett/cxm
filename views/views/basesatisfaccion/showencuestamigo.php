        ...
        <div id="datosPartida" class="col-sm-12" style="display: none">
            ...
            <caption>Tabla de datos</caption>
                <tbody>
                    ...
                    <tr>
                        <th scope="col"><?php echo (strtoupper($preguntas['0']['nombre']) != 'NO APLICA') ? $preguntas['0']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['0']['nombre']) != 'NO APLICA') ? $data->pregunta1 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th scope="col"><?php echo (strtoupper($preguntas['1']['nombre']) != 'NO APLICA') ? $preguntas['1']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['1']['nombre']) != 'NO APLICA') ? $data->pregunta2 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th scope="col"><?php echo (strtoupper($preguntas['2']['nombre']) != 'NO APLICA') ? $preguntas['2']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['2']['nombre']) != 'NO APLICA') ? $data->pregunta3 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th scope="col"><?php echo (strtoupper($preguntas['3']['nombre']) != 'NO APLICA') ? $preguntas['3']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['3']['nombre']) != 'NO APLICA') ? $data->pregunta4 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th scope="col"><?php echo (strtoupper($preguntas['4']['nombre']) != 'NO APLICA') ? $preguntas['4']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['4']['nombre']) != 'NO APLICA') ? $data->pregunta5 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th scope="col"><?php echo (strtoupper($preguntas['5']['nombre']) != 'NO APLICA') ? $preguntas['5']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['5']['nombre']) != 'NO APLICA') ? $data->pregunta6 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th scope="col"><?php echo (strtoupper($preguntas['6']['nombre']) != 'NO APLICA') ? $preguntas['6']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['6']['nombre']) != 'NO APLICA') ? $data->pregunta7 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th scope="col"><?php echo (strtoupper($preguntas['7']['nombre']) != 'NO APLICA') ? $preguntas['7']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['7']['nombre']) != 'NO APLICA') ? $data->pregunta8 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th scope="col"><?php echo (strtoupper($preguntas['8']['nombre']) != 'NO APLICA') ? $preguntas['8']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['8']['nombre']) != 'NO APLICA') ? $data->pregunta9 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th scope="col"><?php echo (strtoupper($preguntas['9']['nombre']) != 'NO APLICA') ? $preguntas['9']['enunciado_pre'] : 'NO APLICA' ?></th>
            ...
            $("#datosGenerales").toggle("slow");
                ...
                <div id="datosGenerales" class="col-sm-12" style="display: none">
                    ...
                    <caption>Tabla datos</caption>
                        <tbody>
                            <tr>
                                <th scope="col">Lider Equipo</th>
                                <td><?php echo $data->lider_equipo ?></td>
                            </tr>
                            <tr>
                                <th scope="col">Programa/PCRC</th>
