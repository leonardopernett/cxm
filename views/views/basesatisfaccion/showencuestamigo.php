        ...
        <div id="datosPartida" class="col-sm-12" style="display: none">
            <table class="table table-striped table-bordered detail-view formDinamico">
                <tbody>
                    ...
                    <tr>
                        <th><?php echo (strtoupper($preguntas['0']['nombre']) != 'NO APLICA') ? $preguntas['0']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['0']['nombre']) != 'NO APLICA') ? $data->pregunta1 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th><?php echo (strtoupper($preguntas['1']['nombre']) != 'NO APLICA') ? $preguntas['1']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['1']['nombre']) != 'NO APLICA') ? $data->pregunta2 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th><?php echo (strtoupper($preguntas['2']['nombre']) != 'NO APLICA') ? $preguntas['2']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['2']['nombre']) != 'NO APLICA') ? $data->pregunta3 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th><?php echo (strtoupper($preguntas['3']['nombre']) != 'NO APLICA') ? $preguntas['3']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['3']['nombre']) != 'NO APLICA') ? $data->pregunta4 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th><?php echo (strtoupper($preguntas['4']['nombre']) != 'NO APLICA') ? $preguntas['4']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['4']['nombre']) != 'NO APLICA') ? $data->pregunta5 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th><?php echo (strtoupper($preguntas['5']['nombre']) != 'NO APLICA') ? $preguntas['5']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['5']['nombre']) != 'NO APLICA') ? $data->pregunta6 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th><?php echo (strtoupper($preguntas['6']['nombre']) != 'NO APLICA') ? $preguntas['6']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['6']['nombre']) != 'NO APLICA') ? $data->pregunta7 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th><?php echo (strtoupper($preguntas['7']['nombre']) != 'NO APLICA') ? $preguntas['7']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['7']['nombre']) != 'NO APLICA') ? $data->pregunta8 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th><?php echo (strtoupper($preguntas['8']['nombre']) != 'NO APLICA') ? $preguntas['8']['enunciado_pre'] : 'NO APLICA' ?></th>
                        <td><?php echo (strtoupper($preguntas['8']['nombre']) != 'NO APLICA') ? $data->pregunta9 : 'NO APLICA' ?></td>
                    </tr>
                    <tr>
                        <th><?php echo (strtoupper($preguntas['9']['nombre']) != 'NO APLICA') ? $preguntas['9']['enunciado_pre'] : 'NO APLICA' ?></th>
