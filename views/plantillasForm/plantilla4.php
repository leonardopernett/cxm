...
$varGuiainspiracion = '<div id="Guiainspiracion" class="col-md-4 guiainspiracion">';
$varDatogenerales = '<div id="Datogenerales" class="col-md-4 datogenerales">';
$varPrincipal = '<div id="Principal" class="col-md-12 principal">';
$varRow = '<div id="Row" class="row">';
$arrayDivs = [];
for ($index = 0; $index < 10; $index++) {
    $arrayDivs[]='<div id="div'.$index.'" class="col-md-4">';
}
$varFin = '</div>';
$cantDivs = 3;
$banderaGuiaInspiracion = 3;
