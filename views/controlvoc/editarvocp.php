...
<?php $form = ActiveForm::begin(['layout' => 'horizontal']); ?>
	<?= $form->field($model, "idlistapadrevoc")->textInput(['readonly' => 'readonly', 'value' => $txtIdList, 'id'=>'invisible_valorado', 'class'=>"hidden"])->label(' ') ?>   

	<?= $form->field($model, "nombrelistap")->textInput(['value' => $txtNombreList, 'id'=>'idListtxt'])->label('Nombre Lista') ?>   
