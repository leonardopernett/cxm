    ...
    <div id="dtbloque1" class="form-group col-sm-12" style="display: inline;">
      <div class="segundalinea">
        <div class="row">
          <div class="col-md-2">
              <div class="card mb">            
                <label><i class="far fa-plus-square" style="font-size: 20px; color: #559FFF;"></i> Crear workspace:</label>
                <br>
                <br>
          ...
          <div class="col-md-2">
              <div class="card mb">          
                <label><i class="far fa-minus-square" style="font-size: 20px; color: #ed3443;"></i> Elimina workspace:</label>
                <br>
                <br>
          ...
          <div class="col-md-2">
              <div class="card mb">             
                <label><i class="far fa-copy" style="font-size: 20px; color: #edac34;"></i> Duplicar reporte:</label>
                <br>
                <br>
          ...
          <div class="col-md-2">
              <div class="card mb">            
                <label><i class="far fa-file-excel" style="font-size: 20px; color: #ed5934;"></i> Eliminar reporte:</label>
                <br>
                <br>
...
<?php if ($sessiones == "2953" || $sessiones == "7" || $sessiones == "3205" || $sessiones == "3468" || $sessiones == "3229" || $sessiones == "57") {?>
          ...
          <div class="col-md-2">
              <div class="card mb">            
                <label><i class="fas fa-unlock-alt" style="font-size: 20px; color: #0cf56d;"></i> Permisos reporte:</label>
                <br>
                <br>
...
<?php if ($sessiones == "2953" || $sessiones == "7" || $sessiones == "3205") {?>
          ...
          <div class="col-md-2">
              <div class="card mb">           
                <label><i class="far fa-id-badge" style="font-size: 20px; color: #ecf23a;"></i> Permisos colaborador:</label>
                <br>
     ...
     if (varareatrabajoid == "" || varreporteid == "") {
        ...
        $.ajax({
              ...
              success : function(response){ 
                    ...
                    //console.log(txtRta);
                    //alert(txtRta.data);
                    //window.location.href = 'reporteframe?rutaframe='+txtRta.data; 
