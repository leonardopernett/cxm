...
<div class="capaUno" style="display: none">
    ...
    <caption>Metrica</caption>
        <thead>
            <tr>
                <th scope="col" class="text-center" colspan="8"><h1><?= Yii::t('app', 'Dashboard Métricas de Productividad Valoración') ?></h1></th>
            </tr>
            <tr>
                <th scope="col" class="text-center" colspan="8"></th>
            </tr>
            <tr>
                <th scope="col" style="background-color: #5D92E2;" class="text-center" colspan="8"><?= Yii::t('app', 'VOLUMEN DE GESTION') ?></th>
            </tr>
            <tr>
                <th scope="col" style="background-color: #5D92E2;"><?= Yii::t('app', 'Nivel') ?></th>
                <?php
                    foreach ($varMonthYear as $key => $value) {
                        $varMonth = $value['CorteMes'];
                        $varYear = $value['CorteYear'];                    
                ?>
                    <th scope="col" style="background-color: #5D92E2;" class="text-center">asdasds<?php echo $varMonth.' - '.$varYear; ?></th>
                <?php
                    }
                ?>
                <th scope="col" style="background-color: #5D92E2;" class="text-center"><?= Yii::t('app', 'Promedio '.$varYear) ?></th> 
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            ?>
            <tr>
                <td style="background-color: #A7B3C5;"  class="text-center"><?php echo $txtNameCity; ?></td>
            ...
            <tr>
                <th scope="col" style="background-color: #5D92E2;" class="text-center" colspan="8"><?= Yii::t('app', 'COSTO X GESTION') ?></th>
            </tr>   
            <tr>
                <th scope="col" style="background-color: #5D92E2;" class="text-center"><?= Yii::t('app', 'Nivel') ?></th>
                <?php
                    foreach ($varMonthYear as $key => $value) {
                        $varMonth = $value['CorteMes'];
                        $varYear = $value['CorteYear'];                    
                ?>
                    <th scope="col" style="background-color: #5D92E2;" class="text-center"><?php echo $varMonth.' - '.$varYear; ?></th>
                <?php
                    }
                ?>
                <th scope="col" style="background-color: #5D92E2;" class="text-center"><?= Yii::t('app', 'Promedio '.$varYear) ?></th>                 
            ...
            <tr>
                <th scope="col" style="background-color: #5D92E2;" class="text-center" colspan="9"><?= Yii::t('app', 'VOLUMEN X CLIENTE') ?></th>
            </tr> 
            <tr>
                <th scope="col" style="background-color: #5D92E2;" class="text-center"><?= Yii::t('app', 'Ciudad') ?></th>
                <th scope="col" style="background-color: #5D92E2;" class="text-center"><?= Yii::t('app', 'Cliente') ?></th>
                <?php
                    foreach ($varMonthYear as $key => $value) {
                        $varMonth = $value['CorteMes'];
                        $varYear = $value['CorteYear'];
            ...
            ?>
            <tr>
                <td style="background-color: #A7B3C5;"  class="text-center"><?php echo $varNameCity; ?></td>
                <td style="background-color: #A7B3C5;" class="text-center"><?php echo $varNamePcrc; ?></td>
                <?php
            ...
            <tr>
                <th scope="col" style="background-color: #5D92E2;" class="text-center" colspan="11"><?= Yii::t('app', 'VOLUMEN X VALORADOR') ?></th>
            </tr> 
            <tr>
                <th scope="col" style="background-color: #5D92E2;" class="text-center"><?= Yii::t('app', 'Ciudad') ?></th>
                <th scope="col" style="background-color: #5D92E2;" class="text-center"><?= Yii::t('app', 'Cliente') ?></th>
                <th scope="col" style="background-color: #5D92E2;" class="text-center"><?= Yii::t('app', 'Identificación') ?></th>
                <th scope="col" style="background-color: #5D92E2;" class="text-center"><?= Yii::t('app', 'Valorador') ?></th>
                <?php
            ...
            ?>
            <tr>
                <td style="background-color: #A7B3C5;"  class="text-center"><?php echo $varCiudad; ?></td>
                <td style="background-color: #A7B3C5;" class="text-center"><?php echo $varServicios; ?></td>
