    ...
    <table class="table table-striped table-bordered detail-view formDinamico" border="0">
		...
		$varSumPromedio = 0;
                foreach ($varMonthYear2 as $key => $value) {
                    ...
                    $varRtaTotal = Yii::$app->db->createCommand("select sum(cantidadvalor) as SumCantidad from tbl_control_volumenxcliente where mesyear = '$varMonth2' and anuladovxc = 0")->queryScalar();
