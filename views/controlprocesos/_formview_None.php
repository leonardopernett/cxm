...
$this->title = 'Ver la Valoración';
    ...
    $txtCantidadcxm = Yii::$app->db->createCommand("select sum(cant_valor) from tbl_control_params where anulado = 0 and evaluados_id = $varIdusua and fechacreacion = '$varFecha'")->queryScalar();
    ...
    $varTotalspeech = Yii::$app->db->createCommand("select sum(cant_valor) from tbl_control_focalizada where anulado = 0 and fechacreacion between '$varFecha' and '$varFecha' and evaluados_id = $varIdusua")->queryScalar();
    ...
    $varCantidad = $txtCantidadcxm  + $varTotalspeech;
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="card1 mb">
                            ...
                            <?= Html::button('Enviar', ['value' => url::to(['gestionenviovaloracion','txtiddelevaluado'=>$varIdusua, 'txtId'=>$txtId]), 'class' => 'btn btn-success', 'id'=>'modalButton5',
                                'data-toggle' => 'tooltip',                
                                'title' => 'Enviar', 
...
<script type="text/javascript">
    ...
    function goesit(){
        // window.open('http://127.0.0.1/qa_pruebas/web/index.php/planvaloracion/index','_blank');
        window.open('https://qa.grupokonecta.local/qa_managementv2/web/index.php/planvaloracion/index','_blank');
    };
</script>