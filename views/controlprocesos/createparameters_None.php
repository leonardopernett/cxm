...
<div id="capaprincipal" style="display: inline">   
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="CapaDos" style="display: inline;">
                        <?php $form = ActiveForm::begin(['layout' => 'horizontal']); ?>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <label style="font-size: 15px;">Dimension: </label>
...
<script type="text/javascript">
    ...
    function speechbtn(){
        ...
        var vardimension = document.getElementById("vardimensionid").value;
        var varcantidad = document.getElementById("varcantidadid").value;
        var varusuario = "<?php echo $txtusua_id ?>";
        ...
        if (varcliente == "") {
            ...
            if (varcantidad == "") {
                event.preventDefault();
                alert("Ingresar una cantidad del plan");
                return;
            }else{
                $.ajax({
                    method: "get",
                    ...
                    data: {
                        ...
                        txtvardimension : vardimension,
                        txtvarcantidad : varcantidad,
                        txtvarusuario : varusuario,
                    },
    ...
    function calculate(){
        ...
        var arbolTxt = document.getElementById("select2-chosen-2").innerText; 
        var arbolTxt2 = document.getElementById("select2-chosen-2").innerText;
