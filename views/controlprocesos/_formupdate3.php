...
?>
	<div class="formularios-form">
		...
		<?php $var2 = ['AGENTES' => 'AGENTES', 'ALTO VALOR' => 'ALTO VALOR', 'CALIDAD DEL ENTRENAMIENTO' => 'CALIDAD DEL ENTRENAMIENTO', 'HEROES POR EL CLIENTE' => 'HEROES POR EL CLIENTE', 'OJT' => 'OJT', 'OTROS' => 'OTROS', 'PRECISI�N Y APRENDIZAJE' => 'PRECISI�N Y APRENDIZAJE', 'PROCESO' => 'PROCESO', 'PROTECCION DE LA EXPERIENCIA' => 'PROTECCION DE LA EXPERIENCIA', 'PRUEBAS' => 'PRUEBAS']; ?>
		...
		<?php $var = ['Comparte varios PCRC' => 'Comparte varios PCRC', 'Incapacidad' => 'Incapacidad', 'Distribuci�n muestra en OJT y calidad Entto' => 'Distribuci�n muestra en OJT y calidad Entto', 'Varios t�cnicos con el mismo PCRC' => 'Varios t�cnicos con el mismo PCRC', 'Licencia/Vacaciones' => 'Licencia/Vacaciones', 'En otras actividades' => 'En otras actividades',  'Suspension' => 'Suspension', 'Calibraciones Incognitas' => 'Calibraciones Incognitas', 'Conexion Tutor' => 'Conexion Tutor', 'Se realiza valoraci�n agente' => 'Se realiza valoraci�n agente', 'Servicio nuevo' => 'Servicio nuevo']; ?>
...
<br>
	...
	<div align="center">
		...
		<h7><strong>Solo es posible hacer la actualizaci�n sobre la cantidad de valoracion modificada si no tiene un argumento valido.</strong></h7>
	</div>
<?php
	}
	else
