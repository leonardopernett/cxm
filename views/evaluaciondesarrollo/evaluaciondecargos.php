...
$this->params['breadcrumbs'][] = $this->title;
    ...
    $varnombrecargo = Yii::$app->db->createCommand("select usua_nombre from tbl_usuarios where usua_identificacion = $vardocument2")->queryScalar();
...
<script src="../../js_extensions/highcharts/exporting.jss"></script>
...
<div id="idCapaUno" style="display: inline"> 
	<div id="capaUno" style="display: inline">   
        <div class="row">
            <div class="col-md-4">
                <div class="card1 mb">
                    <label><em class="fas fa-user-circle" style="font-size: 20px; color: #2CA5FF;"></em> Persona a Cargo:</label>
                    <label><?php echo $varnombrecargo; ?></label>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card1 mb">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card1 mb">
                                ...
                                <?= Html::button('Crear Novedad', ['value' => url::to(['evaluaciondesarrollo/novedadcargos','idvardocumentpar' => $vardocument2]), 'class' => 'btn btn-success', 'id'=>'modalButton1', 'data-toggle' => 'tooltip', 'title' => 'Crear Novedad', 'style' => 'background-color: #4298b4']) 
                                ?> 
