...
$this->params['breadcrumbs'][] = $this->title;
    ...
    $txtlistmensajes = Yii::$app->db->createCommand("select ec.namecompetencia, ef.mensaje, ef.mensajepos, en.nombreeval FROM tbl_evaluacion_mensaje_resul ef
...
<div class="CapaUno" style="display: inline;">
    <div class="row">
        <div class="col-md-12">
            <div class="card1 mb">
                <label style="font-size: 15px;"><em class="fas fa-list" style="font-size: 15px; color: #FFC72C;"></em> Ver mensajes de resultados:</label>
				...
				<caption>Tabla datos</caption>
            		<thead>
            			...
            			<th scope="col" class="text-center"  style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?php echo "Mensaje < 85"; ?></label></th>
                        <th scope="col" class="text-center"  style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?php echo "Mensaje > 85"; ?></label></th>
            		...
            		<tbody>
                        ...
                        ?>
            				<tr>
                                ...
                                <td><label style="font-size: 12px;"><?php echo  $value['mensajepos']; ?></label></td>
