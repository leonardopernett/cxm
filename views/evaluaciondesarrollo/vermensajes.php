...
<div class="CapaUno" style="display: inline;">
    <div class="row">
        <div class="col-md-12">
            <div class="card1 mb">
                <label style="font-size: 15px;"><em class="fas fa-list" style="font-size: 15px; color: #FFC72C;"></em> Ver mensajes de feedback:</label>
            	<table id="tblData" class="table table-striped table-bordered tblResDetFreed">
            		...
            		<thead>    			
            			...
            			<th scope="col" class="text-center"  style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?php echo "Mensaje"; ?></label></th>
