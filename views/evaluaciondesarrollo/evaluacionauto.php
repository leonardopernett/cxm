                ...
                <div class="col-md-12">
                    ...
                    <caption>Tabla</caption>
                        <tr>
                            ...
                            <th id="guardarEvaluacion" class="text-center"><label><?= Yii::t('app', ' Guardando datos de la evaluación realizada') ?></label></td>
                        </tr>
                    </table>                                       
                </div>
            </div>
...
<div id="idCapaUno" style="display: inline"> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card1 mb">
                        ...
                        <div class="row">                    
                            <?php 
                                $varlistcompetencias = Yii::$app->db->createCommand("select ec.idevaluacioncompetencia, ec.namecompetencia from tbl_evaluacion_competencias ec inner join tbl_evaluacion_nivel en on ec.idevaluacionnivel = en.nivel inner join tbl_usuarios_evalua ue on en.cargo = ue.id_dp_posicion where ue.documento in ('$vardocument') and idevaluacionbloques = $varidbloque and ec.anulado = 0 and en.anulado = 0")->queryAll();
                                
                                foreach ($varlistcompetencias as $key => $value) {
                                    $varidcompetencia = $value['idevaluacioncompetencia'];

                                    if ($vardocument == "43271670") {
    ...
    <div id="capaCuatro" style="display: inline"> 
        <div class="row">
            <div class="col-md-12">
                <div class="card1 mb">
                    <label style="font-size: 17px;"><em class="fas fa-comments" style="font-size: 17px; color: #8B70FA;"></em> Ingresa aquí las acciones que consideras pueden potenciar tus competencias </label>
