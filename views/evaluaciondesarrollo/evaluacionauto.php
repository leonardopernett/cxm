...
<div id="idCapaUno" style="display: inline"> 
    ...
    <div id="capaCuatro" style="display: inline"> 
        <div class="row">
            <div class="col-md-12">
                <div class="card1 mb">
                    <label style="font-size: 17px;"><i class="fas fa-comments" style="font-size: 17px; color: #8B70FA;"></i> Ingresa aquí las acciones que consideras pueden potenciar tus competencias </label>
