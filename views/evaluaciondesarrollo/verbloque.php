...
$this->params['breadcrumbs'][] = $this->title;
    ...
    $txtlistrespuestas = Yii::$app->db->createCommand("select * from tbl_evaluacion_bloques where anulado = 0")->queryAll();
...
<div class="CapaUno" style="display: inline;">
    <div class="row">
        <div class="col-md-12">
            <div class="card1 mb">
                <label style="font-size: 15px;"><i class="fas fa-list" style="font-size: 15px; color: #FFC72C;"></i> Ver bloques creados:</label>
            	<table id="tblData" class="table table-striped table-bordered tblResDetFreed">
            		<thead>    			
            			<th class="text-center"  style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?php echo "Bloque"; ?></label></th>
            		...
            		<tbody>
                        ...
                        ?>
            				<tr>
        	      				<td><label style="font-size: 12px;"><?php echo  $value['namebloque']; ?></label></td>
