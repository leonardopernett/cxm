...
<div id="idCapaUno" style="display: inline"> 
    <div id="capaUno" style="display: inline">   
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card1 mb">
                    <label><i class="fas fa-info-circle" style="font-size: 20px; color: #2CA5FF;"></i> Gestión:</label>
        ...
        <div id="capaSiete" style="display: none"> 
            <div class="row">
                <div class="col-md-12">
                    <div class="card1 mb">
                        <div class="col-md-12">
                            <label style="font-size: 17px;"><i class="fas fa-exclamation-circle" style="font-size: 17px; color: #8B70FA;"></i> Información Importante 70-20-10 </label>
