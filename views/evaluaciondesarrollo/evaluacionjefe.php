...
$this->params['breadcrumbs'][] = $this->title;
    ...
    $vardocumentjefe = Yii::$app->db->createCommand("select documento_jefe from tbl_usuarios_evalua where documento = $vardocument group by documento_jefe")->queryScalar();
    $varnombrejefe = Yii::$app->db->createCommand("select usua_nombre from tbl_usuarios where usua_identificacion = $vardocumentjefe group by usua_nombre")->queryScalar();

    $varcargo = Yii::$app->db->createCommand("select distinct cargo_jefe from  tbl_usuarios_evalua where documento_jefe in ('$vardocumentjefe')")->queryScalar();
    $vartipoeva = Yii::$app->db->createCommand("select tipoevaluacion from tbl_evaluacion_tipoeval where idevaluaciontipo = 2 and anulado = 0")->queryScalar();
...
<div id="idCapaUno" style="display: inline"> 
    <div id="capaUno" style="display: inline">   
        <div class="row">
            <div class="col-md-4">
                <div class="card1 mb">
                    <label><em class="fas fa-user-circle" style="font-size: 20px; color: #2CA5FF;"></em> Nombre del Jefe:</label>
                    <label><?php echo $varnombrejefe; ?></label>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card1 mb">
                    <label><em class="fas fa-question-circle" style="font-size: 20px; color: #2CA5FF;"></em> Cargo del Jefe:</label>
            ...
            <div class="col-md-12">
                <div class="card1 mb">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-body" style="background-color: #f0f8ff;">Por favor selecciona la opción que consideres en cada comportamiento, responde con objetividad, transparencia y realiza observaciones con asertividad, así contribuirás con su desarrollo personal y profesional.
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card1 mb">
                        ...
                        <div class="row">                    
                            <?php 
                                $varlistcompetencias = Yii::$app->db->createCommand("select ec.idevaluacioncompetencia, ec.namecompetencia from tbl_evaluacion_competencias ec inner join tbl_evaluacion_nivel en on ec.idevaluacionnivel = en.nivel inner join tbl_usuarios_evalua ue on en.cargo = ue.id_dp_posicion where ue.documento in ('$vardocumentjefe') and idevaluacionbloques = $varidbloque and ec.anulado = 0 and en.anulado = 0")->queryAll();
                                
                                foreach ($varlistcompetencias as $key => $value) {
                                    $varidcompetencia = $value['idevaluacioncompetencia'];

                                    if ($vardocumentjefe == "43271670") {
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card1 mb">
                                ...
                                <?= Html::button('Crear Novedad', ['value' => url::to(['evaluaciondesarrollo/novedadjefe']), 'class' => 'btn btn-success', 'id'=>'modalButton1', 'data-toggle' => 'tooltip', 'title' => 'Crear Novedad', 'style' => 'background-color: #4298b4']) 
                                ?> 
