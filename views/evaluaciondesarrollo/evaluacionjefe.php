...
<div id="idCapaUno" style="display: inline"> 
    <div id="capaUno" style="display: inline">   
        <div class="row">
            <div class="col-md-4">
                <div class="card1 mb">
                    <label><i class="fas fa-user-circle" style="font-size: 20px; color: #2CA5FF;"></i> Nombre del Jefe:</label>
                    <label><?php echo $varnombrejefe; ?></label>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card1 mb">
                    <label><i class="fas fa-question-circle" style="font-size: 20px; color: #2CA5FF;"></i> Cargo del Jefe:</label>
