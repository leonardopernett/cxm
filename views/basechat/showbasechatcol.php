...
$this->params['breadcrumbs'][] = $this->title;
    ...
    $varidencuesta = Yii::$app->request->get('idencuesta');
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card1 mb">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label for="txtfcr" style="font-size: 14px;">Comentario FCR</label>
                            <input type="text" id="txtfcr" name="datetimes" readonly="readonly" value="<?php echo $varcomentario_fcr; ?>" class="form-control" data-toggle="tooltip" title="Comentario fcr">
                        </div>
                    </div>
                </div>
            </div>
