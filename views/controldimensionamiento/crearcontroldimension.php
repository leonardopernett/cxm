        ...
        <div class="row">
          <div class="col-md-6">          
            ...
            <?php
                echo Html::tag('span', '<i class="fas fa-question-circle" style="font-size: 18px; color: #C178G9;"></i>', [
                            'data-title' => Yii::t("app", ""),
                            'data-content' => 'Tiempo documentación, como sugerencia en promedio de 7 a 10 minutos de documentación.',
                            'data-toggle' => 'popover',
                            'style' => 'cursor:pointer;'
                ]);
            ?> 
            ...
            <?php
                echo Html::tag('span', '<i class="fas fa-question-circle" style="font-size: 18px; color: #C178G9;"></i>', [
                            'data-title' => Yii::t("app", ""),
                            'data-content' => 'Se recomienda que este valor no sea mayor al 40%, ya que afecta la eficiencia de la linea. Insertar solo n�meros',
                            'data-toggle' => 'popover',
                            'style' => 'cursor:pointer;'
                ]);
            ?> 
          ...
          <div class="col-md-6">
            ...
            <?php
                echo Html::tag('span', '<i class="fas fa-question-circle" style="font-size: 18px; color: #C178G9;"></i>', [
                            'data-title' => Yii::t("app", ""),
                            'data-content' => 'Duración del servicio. Cuanto en promedio se demora escuchando las llamadas debe ser parecido al AHT del servicio del mes.',
                            'data-toggle' => 'popover',
                            'style' => 'cursor:pointer;'
                ]);
            ?> 
            ...
            <?php
                echo Html::tag('span', '<i class="fas fa-question-circle" style="font-size: 18px; color: #C178G9;"></i>', [
                            'data-title' => Yii::t("app", ""),
                            'data-content' => 'Se recomienda que este valor sea 5% de lo contrario podria alterar los resultados deseados. Cuantos de tus técnicos se encuentran en vacaciones del total de técnicos.',
                            'data-toggle' => 'popover',
                            'style' => 'cursor:pointer;'
                ]);
            ?> 
