            ...
            <div class="card1 mb">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?=  $form->field($model, 'id_dp_clientes', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->dropDownList(ArrayHelper::map(\app\models\Arboles::find()->distinct()->orderBy(['name'=> SORT_ASC])->all(), 'id', 'name'),
                                                  [
                                                    'id' => 'idinfocliente',
                                                    'prompt'=>'Seleccionar...',
                                                  ]
