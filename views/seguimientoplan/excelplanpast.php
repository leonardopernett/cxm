    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <caption>...</caption>
                <thead>
                    <tr>
                        <th scope="col" colspan="22" class="text-center" style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?php echo  'Rango de fecha '.$varfechainicio.' - '.$varfechafin; ?></label></th>
                    </tr>
                    <tr>
                        ...
                        <th scope="col" style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?= Yii::t('app', 'Novedades') ?></label></th>
                        ...
                        <th scope="col" style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?= Yii::t('app', 'Aprobadas Corte 1') ?></label></th>
                        ...
                        <th scope="col" style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?= Yii::t('app', 'Aprobadas Corte 2') ?></label></th>
                        ...
                        <th scope="col" style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?= Yii::t('app', 'Aprobadas Corte 3') ?></label></th>
                        ...
                        <th scope="col" style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?= Yii::t('app', 'Aprobadas Corte 4') ?></label></th>
                ...
                <tbody>
                    ...
                    switch ($varMes) {
                        ...
                        foreach ($varlistaPlany as $key => $value) { 
                            $varcumplicorte1 = 0;
                            $varcumplicorte2 = 0;
                            $varcumplicorte3 = 0;
                            $varcumplicorte4 = 0; 
