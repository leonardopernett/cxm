    	...
    	<div class="col-md-12">
    		...
    		<table id="tblData" class="table table-striped table-bordered tblResDetFreed">
    			<thead>
    				...
    				<tr> 
    					<th style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?= Yii::t('app', 'Documento') ?></label></th>
                        <th style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?= Yii::t('app', 'Nombre') ?></label></th>
                        <th style="background-color: #C6C6C6;"><label style="font-size: 13px;"><?= Yii::t('app', 'Cargo') ?></label></th>   					
    				</tr>
    			</thead>
    			<tbody>
    				<?php 
