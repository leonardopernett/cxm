...
$this->title = 'Dashboard Escuchar + 2.0';
    ...
    if ($fechaIniCat < '2020-01-01') {
      ...
      if ($idArbol == '17' || $idArbol == '8' || $idArbol == '105' || $idArbol == '2575' || $idArbol == '3263' || $idArbol == '1371' || $idArbol == '2253' || $idArbol == '675' || $idArbol == '3070' ||  $idArbol == '3071' ||  $idArbol == '3077' || $idArbol == '3069' || $idArbol == '3110' || $idArbol == '2919' || $idArbol == '3350' || $idArbol == '3110' || $idArbol == '3436') {
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <caption>...</caption>
              ...
              ?>
              <tr>
                <td class="text-center" width="100"><div style="width: 120px; height: 120px;  display:block; margin:auto;"><canvas id="chartContainerA"></canvas></div><span style="font-size: 15px;"><?php echo $totalAgenteDonalds.' %'; ?></span></td> 
                <td class="text-center" width="100"><div style="width: 120px; height: 120px;  display:block; margin:auto;"><canvas id="chartContainerC"></canvas></div><span style="font-size: 15px;"><?php echo $totalCanalDonalds.' %'; ?></span></td> 
                <td class="text-center" width="100"><div style="width: 120px; height: 120px;  display:block; margin:auto;"><canvas id="chartContainerM"></canvas></div><span style="font-size: 15px;"><?php echo $totalMarcaDonalds.' %'; ?></span></td> 
                <td class="text-center" width="100"><div style="width: 120px; height: 120px;  display:block; margin:auto;"><canvas id="chartContainerK"></canvas></div><span style="font-size: 15px;"><?php echo $totalkonecta.' %'; ?></span></td> 
              </tr>
            </table>
          </div>
        </div>
