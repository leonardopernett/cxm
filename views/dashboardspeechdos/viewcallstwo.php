    ...
    <div class="row">
    	<div class="col-md-6">
    		<div class="card3 mb">
    			...
    			<a style="font-size: 13px;" rel="stylesheet" type="text/css" href="../../web/downloadfiles/Manual Configuración Quantify Esp Version 2_Febrero 2018.pdf" target="_blank">Descargar Instructivo</a>
    		</div>	
    	</div>
