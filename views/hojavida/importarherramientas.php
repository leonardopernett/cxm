            ...
            <div class="card1 mb">
                ...
                <div class="row">
                    <div class="col-md-6">                
                        ...
                        <?= $form->field($modelpersona, 'clasificacion', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['maxlength' => 300, 'id'=>'idalcance', 'placeholder'=>'Ingresar el alcance'])?>                    
                    </div>

                    <div class="col-md-6">                        
                        <label style="font-size: 15px;"><span class="texto" style="color: #FC4343">*</span> <?= Yii::t('app', ' Funcionalidades') ?></label>
                        <?= $form->field($modelpersona, 'numero_fijo', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['maxlength' => 300, 'id'=>'idfunciones', 'placeholder'=>'Ingresar la funcionalidad'])?>
                ...
                <div class="row">
                    <div class="col-md-12">                        
                        ...
                        <?= $form->field($modelpersona, 'email', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['maxlength' => 300, 'id'=>'iddetalles', 'placeholder'=>'Ingresar los detalles'])?>    
                    </div>
                </div>   
...
<script type="text/javascript">
    ...
    function verificardata(){
        var varidroles = document.getElementById("idalcance").value;
        var varidsalario = document.getElementById("idfunciones").value;
        var varidtramo = document.getElementById("iddetalles").value;

        if (varidroles == "") {
            event.preventDefault();
            swal.fire("!!! Advertencia !!!","Debe de ingresar alcances","warning");
            return;
        }
        if (varidsalario == "") {
            event.preventDefault();
            swal.fire("!!! Advertencia !!!","Debe de ingresar funciones","warning");
            return;
        }
        if (varidtramo == "") {
            event.preventDefault();
            swal.fire("!!! Advertencia !!!","Debe de ingresar detalles","warning");
            return;
        }
    };
</script>