      ...
      <div class="card1 mb">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <?= $form->field($model4,'ccdirector', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->dropDownList(
                                        [],
                                        [
                                            'prompt' => 'Seleccionar...',
                                            'id' => 'requester2',
          ...
          <div class="col-md-4">
            ...
            <?= $form->field($model4,'ccgerente', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->dropDownList(
                                        [],
                                        [
                                            'prompt' => 'Seleccionar...',
                                            'id' => 'requester3',
