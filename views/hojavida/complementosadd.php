...
$this->title = 'Gestor de Clientes - Datos Complementarios';
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?= $form->field($model, 'hv_idcivil', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['class'=> 'hidden', 'value'=>$varCivil])?>
