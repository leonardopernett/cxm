              ...
              <div class="col-md-4" style="margin-bottom:10px">
               ...
               <div class="form-group">
                   ...
                   <select name="antiguedadrol" class="js-example-basic-single form-control" placeholder="Cliente" required >
                         ...
                         <option value="7 meses - 1 a�o">7 meses - 1 a&ntilde;o</option>
                         <option value="1 a�os - 3 a�os">1 a&ntilde;os - 3 a&ntilde;os</option>
                         <option value="4 a�os - 6 a�os">4 a&ntilde;os - 6 a&ntilde;os</option>
                         <option value="mayor a 6 a�os">mayor a 6 a&ntilde;os</option>
                   </select>
               </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h2 class="modal-title" id="exampleModalCenterTitle"></h2>
         <p><b>Estrat&eacute;gicos:</b> Es aquel contacto de 'nivel superior' que aunque quiz&aacute;s no posee mucho conocimiento de los resultados Operativos, con este contacto se definen las estrategias de desarrollo del canal administrado por Konecta, se definen aspectos de la operaci�n que impactan la rentabilidad de la cuenta. Este contacto es un alto influenciador para el mantenimiento y permanencia de los negocios con Konecta. </p>
