...
$this->title = 'Gestor Plan de Satisfacción - Agregar Acciones a Seguir';
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card1 mb">
                ...
                <?= $form->field($model, 'acciones', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['maxlength' => 100, 'id'=>'idAcciones_string', 'placeholder' => 'Ingresar Acciones a Seguir'])?> 
...
<script type="text/javascript">
    function varVerificarAcciones(){
        var varidAcciones_string = document.getElementById("idAcciones_string").value;

        if (varidAcciones_string == "") {
            event.preventDefault();
            swal.fire("!!! Advertencia !!!","Debe de ingresar las acciones a seguir","warning");
            return;
        }
    };
</script>