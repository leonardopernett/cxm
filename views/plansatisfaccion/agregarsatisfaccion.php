...
<div class="capaInfo" id="idCapaInfo" style="display: inline;">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="card1 mb">
        <label style="font-size: 15px;"><em class="fas fa-minus-circle" style="font-size: 20px; color: #b52aef;"></em> <?= Yii::t('app', 'Cancelar y Regresar') ?></label>
            ...
            ?>
              <tr>
                ...
                <td class="text-center">
                  ...
                  <?= Html::a('<em class="fas fa-times" style="font-size: 15px; color: #FC4343;"></em>',  ['deleteprocesosatisfac','id'=> $value['id_eficacia'],'id_plan'=>$id_plan], ['class' => 'btn btn-primary', 'data-toggle' => 'tooltip', 'style' => " background-color: #337ab700;", 'title' => 'Eliminar']) ?>
                </td>
              </tr>
            <?php
              }
