    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card1 mb">
                ...
                <?= $form->field($model, 'concepto', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['maxlength' => 100, 'id'=>'idConcepto', 'placeholder' => 'Ingresar Concepto de Mejora'])?> 
