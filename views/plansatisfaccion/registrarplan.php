      ...
      <div class="card1 mb">
        ...
        <table id="myTableInfo" class="table table-hover table-bordered" style="margin-top:10px" >
          ...
          <tr>
            ...
            <td  class="text-center"><label style="font-size: 15px;"> <?= Yii::t('app', $varProcesos) ?> </label></td>

            <th scope="col" style="background-color: #C6C6C6;"><label style="font-size: 15px;"><?= Yii::t('app', 'Responsable...') ?></label></th>
            <td  class="text-center"><label style="font-size: 15px;"> <?= Yii::t('app', $vaResponsable) ?> </label></td>
          </tr>
          <tr>
            <th scope="col" style="background-color: #C6C6C6;"><label style="font-size: 15px;"><?= Yii::t('app', 'Actividad...') ?></label></th>
            <td  class="text-center"><label style="font-size: 15px;"> <?= Yii::t('app', $varActividad) ?> </label></td>

            <th scope="col" style="background-color: #C6C6C6;"><label style="font-size: 15px;"><?= Yii::t('app', 'Rol Responsable...') ?></label></th>
            <td  class="text-center"><label style="font-size: 15px;"> <?= Yii::t('app', $varRolResponsable) ?> </label></td>
          </tr>
          <tr>
            ...
            <?php
              if ($varAreas_String != "") {
            ?>
              <td  class="text-center"><label style="font-size: 15px;"> <?= Yii::t('app', $varAreas_String) ?> </label></td>
            <?php
              }else{
            ?>
              <td  class="text-center"><label style="font-size: 15px;"> <?= Yii::t('app', $varOperacion_String) ?> </label></td>
            <?php
              }
            ?>

            <th scope="col" style="background-color: #C6C6C6;"><label style="font-size: 15px;"><?= Yii::t('app', 'Estado...') ?></label></th>
            <td  class="text-center"><label style="font-size: 15px;"> <?= Yii::t('app', $varEstados) ?> </label></td>
          </tr>
      ...
      <div class="card1 mb">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <?= $form->field($model, 'fecha_implementacion', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['id'=>'idfechaimplementacion','class'=>'hidden'])?> 
          </div>
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card1 mb">
        ...
        <?= Html::button('Agregar Datos', ['value' => url::to(['agregarconceptos','id'=>$id_plan,'id_valores'=>0]), 
        ...
        <table id="tblDataConceptos" class="table table-striped table-bordered tblResDetFreed">
          ...
          <tbody>
            <?php
              foreach ($varListaConceptos as $key => $value) {                  
            ?>
              <tr>
                <td><label style="font-size: 12px;"><?php echo  $value['concepto']; ?></label></td>
                <td class="text-center">
                  <?= Html::a('<em class="fas fa-times" style="font-size: 15px; color: #FC4343;"></em>',  ['eliminarconceptos','id_conceptos'=> $value['id_conceptos'],'id_plan'=>$id_plan,'id_valor'=>0], ['class' => 'btn btn-primary', 'data-toggle' => 'tooltip', 'style' => " background-color: #337ab700;", 'title' => 'Eliminar']) ?>
                </td>
              </tr>
            <?php
              }
    ...
    <div class="col-md-6">
      <div class="card1 mb">
        ...
        <?= Html::button('Agregar Datos', ['value' => url::to(['agregarcausas','id'=>$id_plan,'id_valores'=>0]), 
        ...
        <table id="tblDataCausas" class="table table-striped table-bordered tblResDetFreed">
          ...
          <tbody>
            <?php
              foreach ($varListaMejoras as $key => $value) {                  
            ?>
              <tr>
                <td><label style="font-size: 12px;"><?php echo  $value['mejoras']; ?></label></td>
                <td class="text-center">
                  <?= Html::a('<em class="fas fa-times" style="font-size: 15px; color: #FC4343;"></em>',  ['eliminarmejoras','id_mejoras'=> $value['id_mejoras'],'id_plan'=>$id_plan,'id_valor'=>0], ['class' => 'btn btn-primary', 'data-toggle' => 'tooltip', 'style' => " background-color: #337ab700;", 'title' => 'Eliminar']) ?>
                </td>
              </tr>
            <?php
              }
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card1 mb">
        ...
        <?= Html::button('Agregar Datos', ['value' => url::to(['agregaracciones','id'=>$id_plan,'id_valores'=>0]), 
        ...
        <table id="tblDataAcciones" class="table table-striped table-bordered tblResDetFreed">
          ...
          <tbody>
            <?php
              foreach ($varListaAcciones as $key => $value) {                  
            ?>
              <tr>
                <td><label style="font-size: 12px;"><?php echo  $value['acciones']; ?></label></td>
                <td class="text-center">
                  <?= Html::a('<em class="fas fa-times" style="font-size: 15px; color: #FC4343;"></em>',  ['eliminaracciones','id_acciones'=> $value['id_acciones'],'id_plan'=>$id_plan,'id_valor'=>0], ['class' => 'btn btn-primary', 'data-toggle' => 'tooltip', 'style' => " background-color: #337ab700;", 'title' => 'Eliminar']) ?>
                </td>
              </tr>
            <?php
              }
    ...
    <div class="col-md-6">
      <div class="card1 mb">
        ...
        <?= Html::button('Subir Archivos', ['value' => url::to(['subirarchivos','id'=>$id_plan,'id_valores'=>0]), 
        ...
        <table id="tblDataArchivos" class="table table-striped table-bordered tblResDetFreed">
          ...
          <tbody>
            <?php
              foreach ($varListArchivos as $key => $value) {                  
            ?>
              <tr>
                <td><label style="font-size: 12px;"><?php echo  $value['nombre_archivo']; ?></label></td>
                <td class="text-center">
                  <?= Html::a('<em class="fas fa-times" style="font-size: 15px; color: #FC4343;"></em>',  ['eliminararchivos','id_subirarchivos'=> $value['id_subirarchivos'],'id_plan'=>$id_plan,'id_valor'=>0], ['class' => 'btn btn-primary', 'data-toggle' => 'tooltip', 'style' => " background-color: #337ab700;", 'title' => 'Eliminar']) ?>
                </td>
              </tr>
            <?php
              }
...
<script type="text/javascript">
  ...
  function varVerificarSecundaria(){
    var vartxtFechaimplementa = document.getElementById("txtFechaimplementa").value;   
    document.getElementById("idfechaimplementacion").value = vartxtFechaimplementa;
