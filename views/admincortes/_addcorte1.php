...
<div class="formularios-form">
	...
	<div class="form-group">
		<h3 style="color:#100048;"><left>Ingresar Datos Corte 1</left></h3>
		

			<?= $form->field($model1, 'cortetcs')->textInput(['maxlength' => 150, 'id'=>'txttipoCorte', 'readonly' => 'readonly','value' => 'Corte 1'])->label('Corte') ?>
	...
	<div align="center">
		...
		&nbsp;&nbsp;
		<?= Html::submitButton(Yii::t('app', 'Guardar Corte 1'),
