...
?>
    ...
    <?= Html::a('Comparar Equipo',  ['comparar'], ['class' => 'btn btn-success',
...
<div class="page-header" >
    ...
    <table align="center" border="1" class="egt table table-hover table-striped table-bordered">
        <tr>
            <th><p>Valorador: </p><?php echo $nomValorador; ?></th>
            <th><p>Rango de Corte: </p><?php echo $varNametc; ?>  \\ <?php echo $fechainiC; ?> - <?php echo $fechafinC; ?> //</th>
        </tr>
    </table>    
    <hr>
    <br>
    ...
    <table align="center" border="1" class="egt table table-hover table-striped table-bordered">
		...
		<th class="text-center" >  </th>  
                <th class="text-center" colspan="3"><?php echo $txtcorte1; ?></th>
                <th class="text-center" colspan="3"><?php echo $txtcorte2; ?></th>
                <th class="text-center" colspan="3"><?php echo $txtcorte3; ?></th>
                <th class="text-center" colspan="3"><?php echo $txtcorte4; ?></th>
            </tr>  
            <tr>
		<th><?= Yii::t('app', 'PCRC') ?></th>
                <th><?= Yii::t('app', 'Meta') ?></th>
                <th><?= Yii::t('app', 'Realizadas') ?></th>
                <th><?= Yii::t('app', '% Cumplimiento') ?></th>
                <th><?= Yii::t('app', 'Meta') ?></th>
                <th><?= Yii::t('app', 'Realizadas') ?></th>
                <th><?= Yii::t('app', '% Cumplimiento') ?></th>
                <th><?= Yii::t('app', 'Meta') ?></th>
    ...
    <?= Html::a('Justificar Rendimiento',  ['justificar', 'nomVar' => $idValorador], ['class' => 'btn btn-success',
        ...
        <table id="tblData" class="table table-striped table-bordered tblResDetFreed">
            <thead>
                <tr>
                    ...
                    <th><?= Yii::t('app', 'Rango de Corte') ?></th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                   <th><?= Yii::t('app', 'PCRC') ?></th>
                   <th><?= Yii::t('app', 'Dimensiones') ?></th>
                   <th><?= Yii::t('app', 'Metas') ?></th>
               </tr>
               <?php
                    $variable = $dataProvider2->getModels();
                    foreach ($variable as $key => $value) { 
               ...
               <?php } ?>
                <tr>
                    ...
                    <th class="text-center" colspan="3"><?= Yii::t('app', 'Corte 1') ?></th>
                    <th class="text-center" colspan="3"><?= Yii::t('app', 'Corte 2') ?></th>
                    <th class="text-center" colspan="3"><?= Yii::t('app', 'Corte 3') ?></th>
                    <th class="text-center" colspan="3"><?= Yii::t('app', 'Corte 4') ?></th>
                </tr>
                <tr>
