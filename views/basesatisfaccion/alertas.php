        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card1 mb">
                        <?= Html::button('Correo Grupal', ['value' => url::to(['correogrupal']), 'class' => 'btn btn-success', 'id'=>'modalButton1', 'data-toggle' => 'tooltip', 'title' => 'Permisos', 'style' => 'background-color: #4298b4']) ?> 
                                <?php
                                    Modal::begin([
                                        'header' => '<h4><em class="fas fa-list-alt " style="font-size: 20px; color: #559FFF;"></em>Correo Grupal</h4>',
                                        'id' => 'modal1',
                                    ]);
