        ...
        <div class="col-md-12">
            <div class="card1 mb">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label style="font-size: 15px;"><?= Yii::t('app', 'Seleccion connid') ?></label>
                        <?php $var = ['1' => 'Con Connid', '2' => 'Sin Connid']; ?>
                        <?= $form->field($model, 'idllamada', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->dropDownList($var, ['prompt' => 'Seleccionar...', 'id'=>"idconnid"])->label('') ?> 
                    </div>
                    <div class="col-md-6">
                        <label style="font-size: 15px;"><?= Yii::t('app', 'Seleccion Tipo') ?></label>
...
<script type="text/javascript">
    function activar(){
        ...
        var vararbol = document.getElementById("idClientes").value;
