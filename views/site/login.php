...
<script src="../../web/js_extensions/bootstrap.min.js"></script>
<script src="../../web/js_extensions/jquery-1.11.1.min.js"></script>
<style>
  .login-block{
  ...
  /*background: linear-gradient(to bottom, #fff, #b7dfeb); *//* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
  float:left;
  width:100%;
  /*padding : 125px 0;*/
  height:100%;
  ...
  .banner-sec{background:src="../../images/imagenn4.png"  no-repeat left bottom; background-size:over; min-height:360px; border-radius: 0 10px 10px 0; padding:0;}
  .container{background:#fff; border-radius:10px 10px 10px 10px; /*box-shadow:15px 20px 0px rgba(0,0,0,0.2)*/box-shadow: 0 20px 40px -10px rgba(0, 0, 0, 0.3);
    }
  .carousel-inner{border-radius:0 10px 10px 0;}
  .carousel-caption{text-align:left; left:5%;}
  .login-sec{padding: 50px 30px; position:relative;}
  .login-sec .copy-text{position:absolute; width:30%; bottom:20px; font-size:13px; text-align:center;}
  .login-sec .copy-text i{color:#FEB58A;}
  .login-sec .copy-text a{color:#E36262;}
  .login-sec h2{margin-bottom:30px; font-weight:800; font-size:30px; color: #DE6262;}
  .login-sec h2:after{content:" "; width:100px; height:5px; background:#FEB58A; display:block; margin-top:20px; border-radius:3px; margin-left:auto;margin-right:auto}
  .btn-login{background: #DE6262; color:#fff; font-weight:600;}
  .banner-text{width:80%; position:absolute; bottom:40px; padding-left:20px;}
  .banner-text h2{color:#fff; font-weight:600;}
  .banner-text h2:after{content:" "; width:100px; height:5px; background:#FFF; display:block; margin-top:20px; border-radius:3px;}
  .banner-text p{color:#fff;}
  .brand_logo_login{ display:block; margin:auto;}
  /*.logok{width: 120px; height: 35px; margin-bottom:20px; margin-top:25px;margin-left:115px;margin-right:20px;} */
  .logok{display:block; margin:auto;} 
  .sizelet{font-size:15px;}
  .colorinp{color:#858A8A;}
  .nana{width:0px;}
  .center-h {justify-content: center;}
  .center-v {align-items: center;}
  .boton_acep {width: 150px; margin: 0 auto; font-size:16px;}  
}         
</style>
      ...
      <div class="col-md-4 login-sec input-lg">
          ...
          <?php
                ...
                <div class="form-group sizelet"> 
                  <?=
                      $form->field($model, 'username', ['inputOptions' => ['placeholder' => 'Usuario', 'style' => 'font-size:15px; border-radius: 13px;'],
                      ...
                      ?>
                      <?=
                      $form->field($model, 'password', ['inputOptions' => ['placeholder' => 'Clave', 'style' => 'font-size:15px; border-radius: 13px;'],
                          'inputTemplate' => '<div class="has-feedback sizelet">'
