                ...
                if (!\Yii::$app->user->isGuest) {
                    ...
                    echo Nav::widget([
                        ...
                        'items' => [
                             ...
                             */
                             [
                                'label' => Yii::t('app', 'Resumen Gestión'),
                                //'url' => ['/site/dashboard'],
				    ...
				    [
                                       'label' => Yii::t('app', 'Dashboard Speech'),
                                        'url' => ['/dashboardspeech/index'],
                                        'visible' => Yii::$app->user->identity->isControlProcesoCX(),
                                    ],
				    [
                                       'label' => Yii::t('app', 'Dashboard Control Proceso y Automatico'),
                                        'url' => ['/dashboardcontrol/index'],
                                        'visible' => Yii::$app->user->identity->isControlProcesoCX(),
                                    ],
				    [
                            ...
                            [
                                ...
                                //'url' => ['/site/dashboard'],
                                'visible' => Yii::$app->user->identity->isControlProcesoCX() || Yii::$app->user->identity->isVerDesempeno() || Yii::$app->user->identity->isverAbogado() || Yii::$app->user->identity->isjefeop() || Yii::$app->user->identity->isverTecDesempeno() || Yii::$app->user->identity->isveralertas(),
                                'items'=>[
                                    [
                                    ...
                                    [
                                        'label' => Yii::t('app', 'Subir Desempeño'),
                                        'url' => ['basesatisfaccion/upload'],
                                        'visible' => Yii::$app->user->identity->isverTecDesempeno(),
                                    ],
                                    [
                                        'label' => Yii::t('app', 'Gestion Desempeño'),
                                        'url' => ['basesatisfaccion/showlistadesempenolider'],
                                        'visible' => Yii::$app->user->identity->isVerDesempeno(),
                                    ],
                                    [
                                        'label' => Yii::t('app', 'Gestion Desempeño Admin'),
                                        'url' => ['basesatisfaccion/showlistadesempenocompleto'],
                                        'visible' => Yii::$app->user->identity->isverAbogado(),
                                    ],
                                    [
                                        'label' => Yii::t('app', 'Gestion Desempeño Jefe Op'),
                                        'url' => ['basesatisfaccion/showlistadesempenojefeop'],
                                        'visible' => Yii::$app->user->identity->isjefeop(),
                                    ],
                                    [
                                        'label' => Yii::t('app', 'Gestion Preguntas'),
                                        'url' => ['basesatisfaccion/gestionarpreguntas'],
                                        'visible' => Yii::$app->user->identity->isverAbogado(),
                                    ],
                                    [
                                        'label' => Yii::t('app', 'Seguimiento del Tecnico'),
                                        'url' => ['/seguimientoprocesos/index'],
                                        'visible' => Yii::$app->user->identity->isControlProcesoCX(),
                                    ],
                                    [
                                    ...
                                    //[
                                        ...
                                        //'visible' => Yii::$app->user->identity->isverAlertas(),
                                    //],
                                    //[
                                        //'label' => Yii::t('app', 'Alertas de Valoracion'),
                            ...
                            [
                                ...
                                'items' => [
                                    ...
                                    [
                                        'label' => Yii::t('app', 'Instrumento Escucha Focalizada - VOC'),
                                        'url' => ['/controlvoc/index'],
                                        'visible' => Yii::$app->user->identity->isHacerMonitoreo(),
                                    ],
				    [
                                        'label' => Yii::t('app', 'Alinear + - VOC -'),
                            ...
                            [
                                ...
                                'items' => [
                                    ...
                                    [
                                        'label' => Yii::t('app', 'Plan de Valoracion Técnico'),
				    ...
				    [
			            ...
			            [
                                        'label' => Yii::t('app', 'Administracion Reportes PBI'),
					...
					'visible' => Yii::$app->user->identity->isEdEqipoValorado(),
                            ...
                            [
                                ...
                                'items' => [
                                    ...
                                    [
                                        'label' => Yii::t('app', 'Peticiones Desvinculacion Equipos'),
