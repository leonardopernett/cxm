...
<div class="capaGestion" style="display: inline;" id="idCapaGestion">
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="card2 mb">
        <label style="font-size: 15px;"><em class="fas fa-check-circle" style="font-size: 15px; color: #38d043;"></em> Actualiza Datos de Jarvis: </label>
      ...
      <div class="card2 mb">
        <div class="panel panel-default">
          <div class="panel-body " style="background-color: #f0f8ff; text-align: center; font-size: 15px;">
            <?= Yii::t('app', '* Primer Proceso: permite realizar una actualizacion de los datos de Jarvis con respecto a los asesores y lideres en una tabla temporal en CXM.') ?>
          </div>
        </div>
      </div>
    </div>
