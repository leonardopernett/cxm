            ...
            <div class="card1 mb">
                <div class="row">
                    <div class="col-md-6">                
                        ...
                        <?=  $form->field($modelcaso, 'cliente', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->dropDownList(ArrayHelper::map(\app\models\ProcesosClienteCentrocosto::find()->groupby('cliente')->orderBy(['cliente'=> SORT_ASC])->all(), 'idvolumendirector', 'cliente'),
                                          [
                                              'prompt'=>'Seleccionar...',
                                              'id'=>'txtcliente',
                                          ]
                ...
                <div class="col-md-6">
                            ...
                            <?=  $form->field($modelcaso, 'nombre', ['labelOptions' => [], 'template' => $template])->dropDownList(ArrayHelper::map(\app\models\Usuarios::find()->where(['not like', 'usua_nombre', '%no usar%', false])->orderBy(['usua_nombre'=> SORT_ASC])->all(), 'usua_id', 'usua_nombre'),
                                                [
                                                    "onchange"=>"carguedato();",
                                                    'prompt'=>'Seleccionar...',
                                                    'id' => 'requester'
                    ...
                    <div class="col-md-6">                        
                        <label style="font-size: 15px;"><span class="texto" style="color: #FC4343">*</span> <?= Yii::t('app', ' Documento') ?></label>
                        <?= $form->field($modelcaso, 'documento', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['maxlength' => 300, 'id'=>'iddocumento', 'placeholder'=>'Ingresar Número Documento'])?>    
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">                        
                        <label style="font-size: 15px;"><span class="texto" style="color: #FC4343">*</span> <?= Yii::t('app', ' Ingresar Correo') ?></label>
                        <?= $form->field($modelcaso, 'correo', ['labelOptions' => ['class' => 'col-md-12'], 'template' => $template])->textInput(['maxlength' => 300, 'id'=>'idemail', 'placeholder'=>'Ingresar Correo Electrónico'])?>    
                    </div>
                    <div class="col-md-6">                        
...
<script type="text/javascript">
    ...
    function carguedato(){
     var varusua_id = document.getElementById("requester").value;
        ...
        $.ajax({
              ...
              success : function(response){ 
                          ...
                          document.getElementById("iddocumento").value = Rta[0].documento;
                          document.getElementById("idemail").value = Rta[0].email;
