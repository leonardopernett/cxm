...
<?php $form = ActiveForm::begin([
    ...
    ?>
        ...
        <div class="row">
            <div class="col-md-12">        
                <div class="card1 mb">
                    <label><em class="far fa-clipboard" style="font-size: 20px; color: #e8701a;"></em> Tipificación</label>                
                    <br> 
                    <div class="row" >
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-6">                  
                            <label for="txtResponsable" style="font-size: 14px;">Tipo de PQRS </label>                      
                        ...
                        <div class="col-md-6">                  
                            <label for="txtResponsable" style="font-size: 14px;">Estado </label>                      
